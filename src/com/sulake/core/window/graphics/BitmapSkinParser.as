package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_93:String = "hovering";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_356 = SkinLayoutEntity.const_492;
                  break;
               case "move":
                  _loc5_.var_356 = SkinLayoutEntity.const_348;
                  break;
               case "strech":
                  _loc5_.var_356 = SkinLayoutEntity.const_574;
                  break;
               case "tiled":
                  _loc5_.var_356 = SkinLayoutEntity.const_352;
                  break;
               case "center":
                  _loc5_.var_356 = SkinLayoutEntity.const_596;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_355 = SkinLayoutEntity.const_492;
                  break;
               case "move":
                  _loc5_.var_355 = SkinLayoutEntity.const_348;
                  break;
               case "strech":
                  _loc5_.var_355 = SkinLayoutEntity.const_574;
                  break;
               case "tiled":
                  _loc5_.var_355 = SkinLayoutEntity.const_352;
                  break;
               case "center":
                  _loc5_.var_355 = SkinLayoutEntity.const_596;
            }
         }
