package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1967:uint = 0;
      
      public static const const_990:uint = 1;
      
      public static const const_1311:uint = 2;
      
      public static const const_984:uint = 4;
      
      public static const const_1868:uint = 8;
      
      public static const const_1852:uint = 16;
      
      public static const const_2172:uint = 64;
      
      public static const const_2173:uint = 128;
      
      public static const const_1280:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1311:
               ...
               break;
            case GraphicContext.const_1868:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1852:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_984:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1280:
               break;
            case GraphicContext.const_1967:
               break;
            default:
         ...
         if(this.var_938)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2255,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2255,16777215);
                  }
                  var_364 += bitmap.width * bitmap.height * 4;
               }
