package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1515:String = "skin";
      
      private static const const_1516:String = "bitmap";
      
      private static const const_1518:String = "fill";
      
      private static const const_1519:String = "text";
      
      private static const const_1520:String = "label";
      
      private static const const_1517:String = "shape";
      ...
      private var var_2546:Dictionary;
      
      private var var_2547:Dictionary;
      
      private var var_2545:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2546 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1890,this.var_2546);
         this.var_2547 = new Dictionary();
         this.var_2545 = new Dictionary();
         StateCodeTable.fillTables(this.var_2547,this.var_2545);
         this.var_451 = new Dictionary();
         this.var_451[const_1515] = BitmapSkinRenderer;
         this.var_451[const_1516] = BitmapDataRenderer;
         this.var_451[const_1518] = FillSkinRenderer;
         this.var_451[const_1519] = TextSkinRenderer;
         this.var_451[const_1520] = LabelRenderer;
         this.var_451[const_1517] = ShapeSkinRenderer;
         this.var_451[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_451[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_362 == null)
         {
            var_362 = new Array();
            var_362.push(WindowState.const_74);
            var_362.push(WindowState.const_94);
            var_362.push(WindowState.const_96);
            var_362.push(WindowState.const_57);
            var_362.push(WindowState.const_93);
            var_362.push(WindowState.const_89);
            var_362.push(WindowState.const_88);
            var_362.push(WindowState.const_103);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3040 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1890[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1003[param1] == null)
         {
            this.var_1003[param1] = new Array(const_1080);
         }
         this.var_1003[param1][param2] = param3;
         if(this.var_1004[param1] == null)
         {
            this.var_1004[param1] = new Array(const_1080);
         }
         this.var_1004[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1003[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1004[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_106)
