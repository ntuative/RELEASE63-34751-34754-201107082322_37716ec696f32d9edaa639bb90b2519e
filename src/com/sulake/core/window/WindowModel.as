package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_430:Rectangle;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_10 = null;
            this._context = null;
            this._state = WindowState.const_608;
            this.var_939 = null;
         }
      }
      ...
      {
         return this.var_430.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_430.height;
      }
