package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1661:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1662:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_185:IProfiler;
      
      private var var_25:ICore;
      
      private var _window:IFrameWindow;
      
      private var var_3093:Array;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3093 = new Array();
         this.var_185 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1661() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_185)
         {
            this.var_185.removeStopEventListener(this.refresh);
            this.var_185 = null;
         }
         if(!this.var_185 && param1)
         {
            this.var_185 = param1;
            this.var_185.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_592)
            {
               this.var_2133 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_185.getProfilerAgentsInArray();
         ...
         if(this.var_2133)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_185.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_185.numBitmapAssetInstances + " / " + this.var_185.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_185.numTrackedBitmapDataInstances + " / " + this.var_185.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1662() as ByteArray;
