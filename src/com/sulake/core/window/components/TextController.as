package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1413:Dictionary = createPropertySetterTable();
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_459,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_459 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_459,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_806 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_936 * this.maxScrollH,this.var_603 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_883,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1163));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1249 ? new PropertyStruct(PropertyDefaults.const_951,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1340) : PropertyDefaults.const_1740);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_36,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_147,this._field.borderColor != 0));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1370 ? new PropertyStruct(PropertyDefaults.const_1205,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1277) : PropertyDefaults.const_1965);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_881) ? new PropertyStruct(PropertyDefaults.const_407,this._field.textColor,PropertyStruct.const_147,true) : PropertyDefaults.const_1309);
         ...
         _loc1_.push(this.var_42.left != PropertyDefaults.const_914 ? new PropertyStruct(PropertyDefaults.const_275,this.var_42.left,PropertyStruct.const_37,true) : PropertyDefaults.const_869);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_814 ? new PropertyStruct(PropertyDefaults.const_287,this.var_42.top,PropertyStruct.const_37,true) : PropertyDefaults.const_1019);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_789 ? new PropertyStruct(PropertyDefaults.const_300,this.var_42.right,PropertyStruct.const_37,true) : PropertyDefaults.const_871);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_803 ? new PropertyStruct(PropertyDefaults.const_310,this.var_42.bottom,PropertyStruct.const_37,true) : PropertyDefaults.const_994);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1299 ? new PropertyStruct(PropertyDefaults.const_849,this._field.mouseWheelEnabled,PropertyStruct.const_36,true) : PropertyDefaults.const_1861);
