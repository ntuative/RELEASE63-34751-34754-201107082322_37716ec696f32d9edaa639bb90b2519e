package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1044:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1950:StyleSheet = null;
      ...
      {
         this.var_845 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      {
         if(PropertyDefaults.const_980.indexOf(param1) > -1)
         {
            this.var_845 = param1;
         }
      }
      ...
      {
         return this.var_845 == LinkTarget.const_30 ? defaultLinkTarget : this.var_845;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1950;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1260)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_845 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_929,this.var_845,PropertyStruct.const_52,true,PropertyDefaults.const_980));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1975);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_929)
            {
