package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1457:String = "_TITLE";
      
      private static const const_1631:String = "_HEADER";
      
      private static const const_1632:String = "_CONTENT";
      
      private static const const_1633:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1627:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1457) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1627 = findChildByTag(const_1631) as IHeaderWindow;
            if(!this.var_1627)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_201 = findChildByTag(const_1632) as IWindowContainer;
            if(!this.var_201)
            {
      ...
      {
         return findChildByTag(const_1633) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1420,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_320);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_298);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_305);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_298,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_298,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_330,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_275,_loc3_.left,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_287,_loc3_.top,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_300,0 - _loc3_.right,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_310,0 - _loc3_.bottom,PropertyStruct.const_37,_loc2_));
         return _loc1_;
      }
