package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_517)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_517)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_746,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1764);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1304)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_859,param1.toolTipDelay,PropertyStruct.const_254,true));
         }
         else
         {
      ...
      {
         this.var_1419 = param1 == null ? "null" : param1;
      }
