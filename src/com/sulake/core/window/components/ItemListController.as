package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2269:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_192 = var_511 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_443,WindowStyle.const_106,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this.resizeOnItemUpdate = this.var_1426;
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_755)
         {
            ...
            _loc2_ = WindowEvent.allocate(WindowEvent.const_497,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_528,param1);
            }
            else
            {
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_44:
               this.var_2268 = _loc3_;
               this.var_2267 = _loc4_;
               this.var_1424 = 0;
               this.var_1425 = 0;
               this.var_1423 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_194:
               if(this.var_1423)
               {
                  this.var_1424 = this.var_2268 - _loc3_;
                  this.var_1425 = this.var_2267 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1424 != 0 && this.var_125 != 0)
                     {
                        this.scrollH += this.var_1424 / this.var_125;
                     }
                  }
                  else if(this.var_1425 != 0 && this.var_109 != 0)
                  {
                     this.scrollV += this.var_1425 / this.var_109;
                  }
                  this.var_2268 = _loc3_;
                  this.var_2267 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_273:
               if(this.var_1423)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1424,0);
                  }
                  else
                  {
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1150 && !this.var_610 && this._container)
         {
            this.var_610 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_889)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_417,this._spacing,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1295);
         }
         if(this.var_1150 != PropertyDefaults.const_1211)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_738,this.var_1150,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1908);
         }
         if(this.var_513 != PropertyDefaults.const_1203)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_793,this.var_513,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1837);
         }
         if(this.var_1426 != PropertyDefaults.const_1405)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_942,this.var_1426,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1878);
         }
         if(this.var_756 != PropertyDefaults.const_1343)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1001,this.var_756,PropertyStruct.const_125,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1971);
         }
         if(this.var_753 != PropertyDefaults.const_1221)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_772,this.var_753,PropertyStruct.const_125,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_417:
