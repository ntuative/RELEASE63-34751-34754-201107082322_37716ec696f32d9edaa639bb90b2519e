package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_358)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1325)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_935;
         if(this.var_935 != param1)
         {
            if(this.var_935 != null)
            {
               if(!this.var_935.disposed)
               {
                  this.var_935.deactivate();
               }
            }
            this.var_935 = param1;
