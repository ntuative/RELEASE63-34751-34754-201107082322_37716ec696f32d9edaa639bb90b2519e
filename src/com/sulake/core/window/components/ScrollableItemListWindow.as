package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1361:IItemListWindow;
      
      private var var_475:IScrollbarWindow;
      
      private var var_2095:Boolean = true;
      ...
      override public function dispose() : void
      {
         if(this.var_475)
         {
            this.var_475.removeEventListener(WindowEvent.const_313,this.scrollBarEventProc);
            this.var_475.removeEventListener(WindowEvent.const_302,this.scrollBarEventProc);
            this.var_475 = null;
         }
         if(this.var_1361)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1361)
         {
            this.var_1361 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_475)
         {
            this.var_475 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_475)
            {
               this.var_475.addEventListener(WindowEvent.const_313,this.scrollBarEventProc);
               this.var_475.addEventListener(WindowEvent.const_302,this.scrollBarEventProc);
            }
         }
         return this.var_475;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_302)
         {
            this.hideScrollBar();
         }
      }
