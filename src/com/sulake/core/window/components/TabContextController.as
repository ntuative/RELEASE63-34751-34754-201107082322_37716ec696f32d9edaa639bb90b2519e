package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1637:String = "_SELECTOR";
      
      private static const const_1636:String = "_CONTENT";
       
      
      protected var var_1147:ITabSelectorWindow;
      
      protected var var_2260:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1147 = findChildByTag(const_1637) as ITabSelectorWindow;
            if(this.var_1147 != null)
            {
               this.var_1147.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2260 == null)
         {
            this.var_2260 = findChildByTag(const_1636) as IWindowContainer;
         }
      ...
      {
         return !!this.var_867 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1147.numSelectables;
      }
