package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2215:String = "_INCLUDE";
      
      public static const const_2200:String = "_TEMP";
      
      private static const const_1685:String = "layout";
      
      private static const const_1144:String = "window";
      
      private static const const_1146:String = "variables";
      
      private static const const_1145:String = "filters";
      
      private static const const_718:String = "name";
      
      private static const const_1678:String = "style";
      
      private static const const_727:String = "params";
      
      private static const const_1680:String = "tags";
      ...
      private static const const_1684:String = "visible";
      
      private static const const_1679:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1239:String = "blend";
      
      private static const const_1683:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1689:String = "treshold";
      
      private static const const_1687:String = "children";
      
      private static const const_1691:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1681:String = "height_min";
      
      private static const const_1688:String = "height_max";
      
      private static const const_726:String = "true";
      
      private static const const_180:String = "0";
      
      private static const const_1686:String = "$";
      
      private static const const_1557:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1690:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1682:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1713:Dictionary;
      
      protected var var_2270:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1427,this.var_1428);
         this.var_1151 = new Dictionary();
         this.var_1713 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1151,this.var_1713);
         this.var_2270 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1682,const_50);
         return param1.replace(const_1690,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1713)
            {
               delete this.var_1713[_loc1_];
            }
            this.var_2270.dispose();
            this.var_2270 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1685)
         {
            _loc8_ = param1.child(const_1146);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1145).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1144);
         ...
         if(param1.localName() == const_1144)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1427[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_718,variables,"")));
         style = uint(this.parseAttribute(xml,const_1678,variables,style));
         params = uint(this.parseAttribute(xml,const_727,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1680,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_180));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_180));
         rect.width = Number(this.parseAttribute(xml,name_2,variables,const_180));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_180));
         visible = this.parseAttribute(xml,const_1684,variables,visible.toString()) == const_726;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_727).length() > 0)
         {
            list = xml.child(const_727).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_718,variables,"") as String;
               if(this.var_1151[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_718)) + "\"!");
               }
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1679,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1557);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1146)[0]),tags) as WindowController;
         ...
         window.limits.minHeight = int(this.parseAttribute(xml,const_1681,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1688,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_726;
         blend = Number(this.parseAttribute(xml,const_1239,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1683,variables,window.clipping.toString()) == const_726;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1689,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1145).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_234)
                     {
                        window.x = rect.x;
                     }
