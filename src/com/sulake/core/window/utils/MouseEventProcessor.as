package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_746:Point;
      
      protected var var_190:WindowController;
      
      protected var var_71:WindowController;
      
      protected var var_187:IWindowRenderer;
      
      protected var var_96:IDesktopWindow;
      
      protected var var_934:IWindowContextStateListener;
      ...
      {
         super();
         this.var_746 = new Point();
         if(var_363 == null)
         {
            var_363 = new Array();
            var_363[0] = MouseCursorType.const_345;
            var_363[1] = MouseCursorType.const_30;
            var_363[2] = MouseCursorType.const_345;
            var_363[3] = MouseCursorType.const_345;
            var_363[4] = MouseCursorType.const_345;
            var_363[5] = MouseCursorType.const_30;
            var_363[6] = MouseCursorType.const_345;
         }
         if(var_317 == null)
         {
            var_317 = new Array();
            var_317[0] = WindowState.const_88;
            var_317[1] = WindowState.const_89;
            var_317[2] = WindowState.const_93;
            var_317[3] = WindowState.const_74;
            var_317[4] = WindowState.const_57;
            var_317[5] = WindowState.const_96;
            var_317[6] = WindowState.const_94;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_273;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_71 = state.var_1409 as WindowController;
         this.var_190 = state.var_1407 as WindowController;
         this.var_187 = state.renderer;
         this.var_934 = state.var_1410;
         eventQueue.begin();
         this.var_746.x = -1;
         this.var_746.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_746.x || event.stageY != this.var_746.y)
            {
               this.var_746.x = event.stageX;
               this.var_746.y = event.stageY;
               array = new Array();
               this.var_96.groupParameterFilteredChildrenUnderPoint(this.var_746,array,WindowParam.const_31);
            }
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_934.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1409 = this.var_71;
         state.var_1407 = this.var_190;
         state.renderer = this.var_187;
         state.var_1410 = this.var_934;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         var _loc5_:BitmapData = this.var_187.getDrawBufferForRenderable(param1);
         if(!param1.validateLocalPointIntersection(_loc4_,_loc5_))
         {
            return null;
         }
         if(param1.testParamFlag(WindowParam.const_628))
         {
