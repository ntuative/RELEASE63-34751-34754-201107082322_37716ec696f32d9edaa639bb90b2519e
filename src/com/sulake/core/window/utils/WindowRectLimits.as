package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_349:int = -2.147483648E9;
      ...
      {
         this.var_349 = param1;
         if(this.var_349 > int.MIN_VALUE && !this._target.disposed && this._target.width < this.var_349)
         {
      ...
      {
         return this.var_349 == int.MIN_VALUE && this.var_350 == int.MAX_VALUE && this.var_347 == int.MIN_VALUE && this.var_348 == int.MAX_VALUE;
      }
      
      public function setEmpty() : void
      {
         this.var_349 = int.MIN_VALUE;
      ...
      public function limit() : void
      {
         ...
         {
            if(this._target.width < this.var_349)
            {
               this._target.width = this.var_349;
            }
