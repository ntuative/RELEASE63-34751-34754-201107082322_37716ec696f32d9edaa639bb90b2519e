package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_2199:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1351:uint = 4;
       
      
      protected var var_804:uint = 0;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1413 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1413);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1682 & const_1351)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_804 + "]";
      }
