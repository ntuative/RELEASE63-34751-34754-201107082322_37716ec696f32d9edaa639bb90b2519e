package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1849:IConnectionStateListener;
      ...
      override public function dispose() : void
      {
         ...
         this.var_806 = null;
         for each(_loc3_ in this.var_1512)
         {
         }
         var _loc5_:* = null;
         this.var_1232 = null;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_1308:
               _loc3_ = new SocketConnection(param1,this,this.var_1849);
               break;
            default:
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = this.var_806[_loc3_];
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in this.var_1512)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
