package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1765:int = 10000;
      ...
      private var var_567:ByteArray;
      
      private var var_1309:IEncryption;
      
      private var var_852:IProtocol;
      
      private var _id:String;
      
      private var var_1308:IMessageClassManager;
      
      private var var_283:ICoreCommunicationManager;
      
      private var var_566:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_283 = param2;
         this.var_567 = new ByteArray();
         this.var_1308 = new MessageClassManager();
         this.var_85 = new Socket();
         this.var_227 = new Timer(const_1765,1);
         this.var_227.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_227.stop();
            this.var_227.removeEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
         }
         this.var_227 = null;
         this.var_567 = null;
         this.var_566 = null;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         ...
         if(this.var_566)
         {
            this.var_566.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_227.start();
         this.var_853 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1308.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         var _loc6_:ByteArray = this.var_852.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_566)
         {
            this.var_566.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1309 != null)
         {
            _loc3_ = this.var_1309.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1308.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_852.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_852.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1309 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_852.getMessages(this.var_567,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_566)
               {
                  this.var_566.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1308.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_567,offset);
               this.var_567 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_567.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_567.writeByte(this.var_85.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_227.stop();
         this.var_1996 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_853));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1996 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_853));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_853));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_853));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_853));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_853));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_227.delay + " ms). Possible Firewall.";
