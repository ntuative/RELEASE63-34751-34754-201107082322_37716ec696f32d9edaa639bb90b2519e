package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1395:String = "AssetLibraryReady";
      
      public static const const_956:String = "AssetLibraryLoaded";
      
      public static const const_1778:String = "AssetLibraryUnloaded";
      
      public static const const_1730:String = "AssetLibraryLoadError";
      
      private static const const_718:String = "name";
      
      private static const const_1124:String = "asset";
      
      private static const const_1126:String = "param";
      ...
      private static var var_2094:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_581;
         this.var_474 = new Dictionary(false);
         this.var_580 = new Dictionary(false);
         this.var_1093 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_716 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1125);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1124);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_718);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1126);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_716 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1094.splice(var_1094.indexOf(this),1);
            --var_581;
            this.var_580 = null;
            this.var_1093 = null;
            this.var_184 = null;
      ...
      {
         if(this.var_716 == param1.url && this.var_1092)
         {
            if(!this.var_1095 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_715);
            }
            this.var_1095 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1395));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_1093)
         {
            delete this.var_1093[_loc1_];
         }
         if(this.var_44 != null)
         {
            this.var_44.dispose();
      ...
      {
         var _loc2_:Class = this.var_1093[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_580[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1241,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1168,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1372,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1257,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_580[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_580[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_580[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return this.var_184[param1] != null || (this.var_715 != null ? this.var_715[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_2094.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_474.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_474[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_474[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_474)
         {
            _loc3_ = AssetTypeDeclaration(this.var_474[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_474)
         {
            _loc4_ = AssetTypeDeclaration(this.var_474[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_715 = _loc2_.resource;
         this.var_716 = _loc2_.url;
         if(this.var_1095)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_715);
         }
         this.var_1092 = true;
         dispatchEvent(new Event(AssetLibrary.const_956));
         dispatchEvent(new Event(AssetLibrary.const_1395));
         if(this.var_1095)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1730));
         this.var_44 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1125);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1124);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_718) && _loc3_.attribute(const_718).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_716 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_715[param1]);
                     _loc6_ = _loc3_.child(const_1126);
