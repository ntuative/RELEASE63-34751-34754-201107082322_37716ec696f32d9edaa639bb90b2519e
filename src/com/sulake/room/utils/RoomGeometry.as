package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_527:Number = 64;
      
      public static const const_1236:Number = 32;
      ...
      private var var_493:Number = 1.0;
      ...
      private var var_3095:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1393 = new Vector3d();
         this.var_490 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1392 = new Vector3d();
         this.var_2182 = 1;
         this.var_2181 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2180 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_490.assign(this.var_107);
         this.var_490.x *= this.var_492;
         this.var_490.y *= this.var_491;
         this.var_490.z *= this.var_493;
         return this.var_490;
      }
      ...
      {
         if(this.var_492 != param1 * this.var_2182)
         {
            this.var_492 = param1 * this.var_2182;
            ++this.var_188;
         }
      }
      ...
      {
         if(this.var_491 != param1 * this.var_2181)
         {
            this.var_491 = param1 * this.var_2181;
            ++this.var_188;
         }
      }
      ...
      {
         if(this.var_493 != param1 * this.var_2180)
         {
            this.var_493 = param1 * this.var_2180;
            ++this.var_188;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_107.x /= this.var_492;
         this.var_107.y /= this.var_491;
         this.var_107.z /= this.var_493;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_494.x;
         var _loc3_:Number = this.var_494.y;
         var _loc4_:Number = this.var_494.z;
         this.var_494.assign(param1);
         this._direction.assign(param1);
         if(this.var_494.x != _loc2_ || this.var_494.y != _loc3_ || this.var_494.z != _loc4_)
         {
            ++this.var_188;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1393.assign(this.var_175);
         }
         else
         {
      ...
      private function method_11(param1:IVector3d) : IVector3d
      {
         var _loc2_:* = null;
         if(this.var_601 != null)
         {
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1392.assign(_loc22_);
         }
         else
         {
            this.var_1392.assign(_loc17_);
         }
         ++this.var_188;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_492;
         _loc2_.y *= this.var_491;
         _loc2_.z *= this.var_493;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1392);
         if(_loc3_ < this.var_3095 || _loc3_ > this.var_3096)
         {
            return null;
         }
         ...
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         var _loc6_:IVector3d = this.method_11(param1);
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_491;
            _loc2_.z *= this.var_493;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1392);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_107.x * this.var_492,this.var_107.y * this.var_491,this.var_107.z * this.var_493);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_175;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_492,param2.y * this.var_491,param2.z * this.var_493);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_492,param3.y * this.var_491,param3.z * this.var_493);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_492,param4.y * this.var_491,param4.z * this.var_493);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1236;
         }
         else
         {
            this.scale = const_527;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_527;
      }
