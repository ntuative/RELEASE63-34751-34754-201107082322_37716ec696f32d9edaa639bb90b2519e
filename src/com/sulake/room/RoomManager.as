package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1987:int = 1;
      ...
      private var var_180:IRoomManagerListener;
      
      private var var_3121:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_941,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_703 == null || this.var_577 == null)
         {
            return;
         }
         this._state = const_1987;
         if(this.var_1350 != null)
         {
            _loc1_ = this.var_1350;
            this.var_1350 = null;
            this.initialize(_loc1_,this.var_180);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_702.indexOf(_loc5_) < 0)
            {
               this.var_61.loadObjectContent(_loc5_,events);
               this.var_702.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      {
         return this.var_114.getWithIndex(param1);
      }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_577.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_577.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_833)
         {
            return;
         }
         if(this.var_61 == null)
         {
            this._state = const_833;
            return;
         }
         if(this.var_61.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(this.var_702.length == 0)
            {
               ...
               {
                  this.var_180.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_833;
            this.var_180.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_180 != null)
            {
               this.var_180.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_1084.indexOf(_loc2_) < 0)
         {
            this.var_1084.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_1084.length > 0)
         {
            _loc2_ = this.var_1084[0];
            this.var_1084.splice(0,1);
            _loc3_ = this.var_61.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_180 != null)
               {
                  this.var_180.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_180 != null)
            {
               this.var_180.contentLoaded(_loc2_,true);
            }
            if(this.var_702.length > 0)
            {
            ...
            _loc5_ = getTimer();
            if(_loc5_ - _loc1_ >= CONTENT_PROCESSING_TIME_LIMIT_MILLISECONDS && this.var_2866)
            {
               this.var_2065 = true;
               break;
            }
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_61 == null || this.var_577 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_577.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_577.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              if(this.var_180 != null)
                              {
                                 this.var_180.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
