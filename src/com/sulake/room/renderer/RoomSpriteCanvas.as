package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_729:Point = new Point(0,0);
      
      private static const const_393:int = 50;
      
      private static const const_1676:int = 50;
      
      private static const const_1142:Number = 60;
      
      private static const const_1675:Number = 50;
      ...
      private var var_297:Sprite;
      
      private var var_163:Sprite;
      
      private var var_116:Sprite;
      
      private var var_725:Map;
      
      private var var_589:Point;
      
      private var var_296:BitmapDataCache;
      
      private var var_730:RoomObjectCache;
      
      private var var_588:Array;
      
      private var var_726:Array;
      
      private var var_1659:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2945:Number = -1.0E7;
      
      private var var_2944:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_297 = new Sprite();
         this.var_297.mouseEnabled = false;
         this.var_116 = new Sprite();
         this.var_116.name = "canvas";
         this.var_116.mouseEnabled = false;
         this.var_297.addChild(this.var_116);
         this.var_116.mouseEnabled = true;
         this.var_116.doubleClickEnabled = true;
         this.var_116.addEventListener(MouseEvent.CLICK,this.clickHandler);
         this.var_116.addEventListener(MouseEvent.DOUBLE_CLICK,this.clickHandler);
         ...
         this.var_730 = new RoomObjectCache(_loc6_);
         this.var_903 = new ColorTransform();
         this.var_728 = new Matrix();
      ...
      {
         this.var_589.x -= param1 - this.var_729;
         this.var_729 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_589.y -= param1 - this.var_727;
         this.var_727 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1124 = true;
            if(this.var_163 != null && !this.var_297.contains(this.var_163))
            {
               this.var_297.addChild(this.var_163);
               this.var_116.mask = this.var_163;
            }
         }
         else if(!param1 && this.var_1124)
         {
            this.var_1124 = false;
            if(this.var_163 != null && this.var_297.contains(this.var_163))
            {
               this.var_297.removeChild(this.var_163);
               this.var_116.mask = null;
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_297.numChildren > 0)
            {
               this.var_297.removeChildAt(0);
            }
            this.var_297 = null;
         }
         this.var_116 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_726.length)
            {
               this.cleanSprite(this.var_726[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_726 = [];
         }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_163 != null)
         {
            this.var_163.graphics.clear();
         }
         else
         {
            this.var_163 = new Sprite();
            this.var_163.name = "mask";
            if(this.var_1124)
            {
               this.var_297.addChild(this.var_163);
               this.var_116.mask = this.var_163;
         ...
         this.var_163.graphics.beginFill(0);
         this.var_163.graphics.drawRect(0,0,param1,param2);
         this.var_587 = param1;
         this.var_590 = param2;
      }
      ...
      {
         this.var_730.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_2129 = !this.var_2129;
         ...
         if(this.var_587 != this.var_2946 || this.var_590 != this.var_2948)
         {
            _loc8_ = true;
         }
         if(this.var_116.x != this.var_729 || this.var_116.y != this.var_727)
         {
            this.var_116.x = this.var_729;
            this.var_116.y = this.var_727;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_588.sortOn("z",0 | 0);
         if(_loc5_ < this.var_588.length)
         {
            this.var_588.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_588[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2946 = this.var_587;
         this.var_2948 = this.var_590;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1658 > 0)
         {
            _loc2_ = param1 - this.var_1658;
            if(_loc2_ > const_1142 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2949 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_896;
               if(this.var_896 == const_393 + 1)
               {
                  this.var_532 = _loc2_;
                  this.var_2131 = this.var_2943;
               }
               else if(this.var_896 > const_393 + 1)
               {
                  _loc3_ = Number(this.var_896 - const_393);
                  this.var_532 = this.var_532 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2131 = this.var_2131 * (_loc3_ - 1) / _loc3_ + Number(this.var_2943) / _loc3_;
                  if(this.var_896 > const_393 + const_1676)
                  {
                     this.var_896 = const_393;
                     if(!this.var_1371 && this.var_532 > const_1142)
                     {
                        this.var_1371 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1371 && this.var_532 < const_1675)
                     {
                        this.var_1371 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_730.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_730.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2129 && this.var_1371);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_729;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_727;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_588.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_729;
                     _loc17_.y = _loc20_ - this.var_727;
      ...
      {
         if(param1 < this.var_587 && param1 + param3 >= 0 && (param2 < this.var_590 && param2 + param4 >= 0))
         {
            if(!this.var_3092)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param2 + param4 >= this.var_590)
         {
            param4 -= this.var_590 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2947)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1109)
         {
            return null;
         }
         return this.var_116.getChildAt(param1) as ExtendedSprite;
      }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(this.var_726.length > 0)
         {
            _loc3_ = this.var_726.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1109)
         {
            this.var_116.addChild(_loc3_);
            ++this.var_1109;
         }
         else
         {
            this.var_116.addChildAt(_loc3_,param2);
         }
         ++this.var_897;
      }
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         if(_loc4_ != null)
         {
            if(_loc4_.varyingDepth != _loc3_.varyingDepth)
            {
               if(_loc4_.varyingDepth && !_loc3_.varyingDepth)
               {
                  this.var_116.removeChildAt(param1);
                  this.var_726.push(_loc4_);
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_897 || this.var_897 == 0)
         {
            _loc4_ = this.var_1109 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_588[param1] as SortableSprite;
      }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_728.identity();
            if(flipH)
            {
               this.var_728.scale(-1,1);
               this.var_728.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_728.scale(1,-1);
               this.var_728.translate(0,data.height);
            }
            finalData.draw(data,this.var_728);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_729);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_903.redMultiplier = tR;
            this.var_903.greenMultiplier = tG;
            this.var_903.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_903);
            if(name.length > 0)
            {
               this.var_296.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_729;
         param2 -= this.var_727;
         this.var_589.x = param1;
         this.var_589.y = param2;
         if(this.var_1370 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_2128;
         }
         this.var_2128 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1370;
         return this.var_2128;
      }
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - this.var_590 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2130,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_725.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_725.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2945 || param2 != this.var_2944)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_725.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_725.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_413 != null && param1 != null)
         {
            this.var_413.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_413 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         while(_loc1_ < this.var_413.length)
         {
            _loc2_ = this.var_413.getKey(_loc1_);
            _loc3_ = this.var_413.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1659.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1370 == 0)
         {
            this.checkMouseHits(this.var_589.x,this.var_589.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1370 = 0;
         ++this.var_2130;
      }
