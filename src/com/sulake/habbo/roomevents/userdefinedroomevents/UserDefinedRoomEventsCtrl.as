package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1562:int = 2;
      ...
      private var var_1946:TriggerConfs;
      
      private var var_1947:ActionTypes;
      
      private var var_1945:ConditionTypes;
      
      private var var_284:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_844:RoomObjectHightLighter;
      
      private var var_197:UserDefinedRoomEventsHelp;
      
      private var var_1273:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1946 = new TriggerConfs();
         this.var_1947 = new ActionTypes();
         this.var_1945 = new ConditionTypes();
         this.var_284 = new Dictionary();
         super();
         this.var_94 = param1;
         this.var_844 = new RoomObjectHightLighter(param1);
         this.var_197 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_284[param1];
            this.var_844.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_284[param1] = param2;
            this.var_844.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1273 = new SliderWindowController(this.var_94,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_94.assets,0,20,1);
         this.var_1273.addEventListener(Event.CHANGE,this.method_9);
         this.var_1273.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_844.hideAll(this.var_284);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1273.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_197.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1562) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1562 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1946);
         this.refreshConfigureElement(this.var_1947);
         this.refreshConfigureElement(this.var_1945);
