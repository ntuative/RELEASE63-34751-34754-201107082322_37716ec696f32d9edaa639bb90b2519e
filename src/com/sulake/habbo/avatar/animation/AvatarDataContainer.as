package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1747:Number = 1.0;
      
      private var var_1746:Number = 1.0;
      
      private var var_1748:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1317:Map;
      
      private var var_2797:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_2008 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2796 = parseInt(_loc2_,16);
         this.var_2798 = parseInt(_loc3_,16);
         ...
         this.var_903 = new ColorTransform(this.var_1747,this.var_1746,this.var_1748,this._alphaMultiplier);
         this.var_1317 = this.generatePaletteMapForGrayscale(this.var_2798,this.var_2796);
      }
      ...
      {
         return this.var_1317.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1317.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1317.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1317.getValue("alphas") as Array;
      }
