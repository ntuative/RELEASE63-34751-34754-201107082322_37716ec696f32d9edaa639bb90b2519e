package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_2008 = parseInt(param2.@ink);
         this.var_2770 = String(param2.@member);
         this.var_2771 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1584 = [];
         this.var_1585 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1584[_loc4_] = parseInt(_loc3_.@dy);
      ...
      {
         if(param1 < this.var_1584.length)
         {
            return this.var_1584[param1];
         }
         return 0;
      }
