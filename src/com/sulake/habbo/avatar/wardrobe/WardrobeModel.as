package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel implements ISideContentModel
   {
      ...
      public function dispose() : void
      {
         var _loc1_:* = null;
         this.var_26 = null;
         for each(_loc1_ in this.var_592)
         {
            _loc1_.dispose();
            _loc1_ = null;
         }
      ...
      private function init() : void
      {
         ...
         if(this.var_592)
         {
            for each(_loc2_ in this.var_592)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
         ...
         while(_loc1_ <= 10)
         {
            this.var_592.add(_loc1_,new WardrobeSlot(this.var_26,_loc1_,this.isSlotEnabled(_loc1_)));
            _loc1_++;
         }
         if(this._view)
         {
      ...
      public function updateSlots(param1:int, param2:Array) : void
      {
         ...
         {
            _loc3_ = this.var_592.getValue(_loc4_.slotId) as WardrobeSlot;
            if(_loc3_)
            {
      ...
      private function isSlotEnabled(param1:int) : Boolean
      {
         if(param1 <= 5)
         {
            return this.var_26.manager.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_35);
         }
         return this.var_26.manager.sessionData.hasUserRight("fuse_larger_wardrobe",HabboClubLevelEnum.const_41);
      }
      
      public function get slots() : Array
      {
         return this.var_592.getValues();
      }
   }
}
