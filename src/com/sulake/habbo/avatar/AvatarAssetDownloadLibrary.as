package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1793:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this.var_1205 = param3 + this.var_785 + ".swf";
         this.var_1205 = this.var_1205.replace("%revision%",this._revision);
      ...
      {
         this._state = var_1793;
         var _loc1_:URLRequest = new URLRequest(this.var_1205);
      ...
      {
         Core.error("Could not load avatar asset library " + this.var_785 + " from URL " + this.var_1205,false,Core.const_1361);
      }
