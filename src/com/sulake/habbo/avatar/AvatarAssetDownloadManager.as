package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_434:AssetLoaderStruct;
      ...
      private const const_2340:int = 100;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_434 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_946 = new Timer(this.const_2340,1);
         this.var_946.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_434)
         {
            this.var_434.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,this.onConfigurationComplete);
            this.var_434.addEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_434)
         {
            this.var_434.removeEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,this.onConfigurationComplete);
            this.var_434.removeEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         if(this.var_945 <= 0)
         {
            HabboWebTools.logEventLog("Figuremap download error " + this.var_1162);
         ...
         else
         {
            ...
            if(this.var_1162.indexOf("?") > 0)
            {
               _loc2_ = this.var_1162 + "&retry=" + this.var_945;
            }
            else
            {
               _loc2_ = this.var_1162 + "?retry=" + this.var_945;
            ...
            this.var_434 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function loadFigureMapData(param1:XML) : void
      {
         ...
         this.var_1722 = true;
         for each(_loc2_ in this.var_1163)
         {
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2280,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1722)
         {
            this.var_1163.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_521[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_521[_loc3_] = _loc6_;
            }
            this.var_947[_loc3_] = _loc4_;
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_947)
         {
            _loc7_ = true;
            _loc4_ = this.var_947[_loc3_];
            ...
            if(_loc7_)
            {
               ...
               delete this.var_521[_loc3_];
            }
         }
         for each(_loc3_ in _loc2_)
         {
            delete this.var_947[_loc3_];
         }
         while(_loc6_ < this.var_759.length)
         {
            _loc5_ = this.var_759[_loc6_];
            if(_loc5_.libraryName == (param1.target as AvatarAssetDownloadLibrary).libraryName)
            {
               this.var_759.splice(_loc6_,1);
            }
            _loc6_++;
         }
         this.var_946.start();
      ...
      {
         var _loc1_:* = null;
         while(this.var_760.length > 0 && this.var_759.length < this.const_2030)
         {
            _loc1_ = this.var_760[0];
            _loc1_.startDownloading();
            this.var_759.push(this.var_760.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_760.indexOf(param1) == -1 && this.var_759.indexOf(param1) == -1)
         {
