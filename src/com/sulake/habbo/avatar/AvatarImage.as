package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1487:String = "Default";
      
      private static const const_1488:int = 2;
      
      private static const const_1489:String = AvatarSetType.const_42;
      ...
      protected var var_309:AvatarImageCache;
      
      protected var _figure:AvatarFigureContainer;
      
      protected var var_608:IAvatarDataContainer;
      
      protected var var_361:Array;
      
      protected var var_48:BitmapData;
      
      private var var_976:IActiveActionData;
      ...
      private var var_2884:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this._figure = param3;
         this.var_309 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1489,const_1488);
         this.var_361 = new Array();
         this.var_976 = new ActiveActionData(AvatarAction.const_413);
         this.var_976.definition = this._structure.getActionDefinition(const_1487);
         this.resetActions();
      ...
      {
         param2 += this.var_1818;
         if(param2 < AvatarDirectionAngle.const_1335)
         {
            param2 = AvatarDirectionAngle.const_354 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_354)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_711,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_294.length == 1 && this.var_102 == this.var_1924)
         {
            return this.var_102 + this.var_579 + this.var_711 % 4;
         }
         if(this.var_294.length == 2)
         {
            for each(_loc1_ in this.var_294)
            {
               ...
               {
                  return this.var_102 + this.var_579 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_711 % 11;
                  return this.var_102 + "_" + this.var_1924 + this.var_579 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2886 || param2 != this.var_2884 || param1 != this.var_2885)
         {
            this.var_2886 = param3;
            this.var_2884 = param2;
            this.var_2885 = param1;
            this.var_2082 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_711);
         ...
         {
            if(this.var_608.paletteIsGrayscale)
            {
               ...
               this.var_48 = _loc13_;
               this.var_48.paletteMap(this.var_48,this.var_48.rect,new Point(0,0),this.var_608.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_711);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_361.push(new ActiveActionData(param1,param2,this.var_711));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_315 = this.var_976;
         this.var_315.definition = this.var_976.definition;
         this.resetBodyPartCache(this.var_976);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_294)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_579 = "";
         this.var_294 = this._structure.sortActions(this.var_361);
         if(this.var_294 == null)
         {
            this.var_851 = new Array(0,0,0);
            if(this.var_1359 != "")
            {
               _loc1_ = true;
               this.var_1359 = "";
         ...
         {
            this.var_851 = this._structure.getCanvasOffsets(this.var_294,this._scale,this.var_102);
            for each(_loc4_ in this.var_294)
            {
               this.var_579 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_374)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1642 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1642 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1359 != this.var_579)
            {
               _loc1_ = true;
               this.var_1359 = this.var_579;
            }
         }
         this.var_1490 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_294)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_977 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1818 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_608 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_340 || _loc1_.actionType == AvatarAction.const_256 || _loc1_.actionType == AvatarAction.const_425)
               {
                  this.var_977 = true;
               }
            }
