package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private static const const_1439:int = 5000;
      
      private static const const_1440:Point = new Point(100,30);
      ...
      private var var_240:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1160 = [];
         this.var_1441 = [AvatarEditorFigureCategory.const_812,AvatarEditorFigureCategory.const_56,AvatarEditorFigureCategory.const_303,AvatarEditorFigureCategory.const_948,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_111];
         super();
         this.var_23 = param1;
         if(var_1408 == null)
         {
         ...
         this._saveTimer = new Timer(const_1439,1);
         this._saveTimer.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param2 == null)
         {
            param2 = this.var_1441;
         }
         for each(_loc3_ in param2)
         {
            this.var_1160.push(_loc3_);
         }
         this.createWindow();
      }
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         if(_loc3_)
         {
            this.var_83 = this.var_23.manager.windowManager.buildFromXML(_loc3_.content as XML) as IFrameWindow;
         }
         if(this.var_83 == null)
         {
         ...
         this.var_83.position = const_1440;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_613 == null)
            {
               this.var_613 = this.var_23.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_72,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_613.addChild(this.var_58);
            }
            _loc3_ = this.var_613.getChildIndex(this.var_58);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
            this.var_613.visible = true;
         }
         return true;
      }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1441);
         }
         if(param1.length != this.var_1160.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1160.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_240 = this.var_58.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc1_:int = this.var_240.numSelectables - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_240.getSelectableAt(_loc1_);
            if(_loc2_ != null && this.var_1160.indexOf(_loc2_.name) < 0)
            {
               _loc3_ = this.var_240.removeSelectable(_loc2_);
               _loc4_ = _loc1_ + 1;
               while(_loc4_ < this.var_240.numSelectables)
               {
                  this.var_240.getSelectableAt(_loc4_).x = this.var_240.getSelectableAt(_loc4_).x - _loc3_.width;
                  _loc4_++;
               }
            }
            _loc1_--;
         }
         this.var_240.setSelected(this.var_240.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1441;
      ...
      public function update() : void
      {
         ...
         if(this.var_23.manager.sessionData && this.var_23.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_35 && (this.var_1440 == AvatarEditorSideCategory.const_111 || this.var_2279))
         {
            _loc4_ = "null";
         }
      ...
      {
         if(this.var_1440 == AvatarEditorSideCategory.const_111)
         {
            this.var_2279 = false;
            this.setSideContent(AvatarEditorSideCategory.const_595);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_595:
               break;
            case AvatarEditorSideCategory.const_603:
               _loc3_ = this.var_23.getSideContentWindowContainer(AvatarEditorSideCategory.const_603);
               break;
            case AvatarEditorSideCategory.const_111:
               _loc3_ = this.var_23.getSideContentWindowContainer(AvatarEditorSideCategory.const_111);
         }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_375 = param1;
         this.var_240.setSelected(this.var_240.getSelectableByName(param1));
      }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_318)
         {
            ...
            this.var_318 = this.var_23.manager.windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
      ...
      private function openCatalogClubPage() : void
      {
         ...
         {
            this.var_23.manager.catalog.openCatalogPage(CatalogPageName.const_171,true);
         }
      }
   }
}
