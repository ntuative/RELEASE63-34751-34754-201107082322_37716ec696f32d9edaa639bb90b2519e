package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_309:AvatarImageCache;
      ...
      private var var_608:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_56)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1489);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_711);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_711);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_711);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_711);
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_579 = this.var_579 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_432:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1844:
                  case AvatarAction.const_1912:
                  case AvatarAction.const_1312:
                  case AvatarAction.const_1173:
                  case AvatarAction.const_1771:
                  case AvatarAction.const_1978:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_976);
         this.getCache().resetBodyPartCache(this.var_976);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1491 = this._structure.sortActions(this.var_361);
         if(this.var_1491 == null)
         {
            this.var_851 = new Array(0,0,0);
         }
         else
         {
            this.var_851 = this._structure.getCanvasOffsets(this.var_1491,this._scale,this.var_102);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1491)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_256)
               {
                  this.var_977 = true;
               }
