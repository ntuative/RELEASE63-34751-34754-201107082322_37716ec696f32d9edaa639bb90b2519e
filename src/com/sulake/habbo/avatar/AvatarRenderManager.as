package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2346:String = "hd-99999-99999";
      ...
      private var var_1848:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_620 = RenderMode.const_1984;
         this.var_326 = new Map();
         this.var_119 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_138,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_119.add(AvatarType.const_138,_loc4_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_327.init();
         this.var_805.init();
         _loc2_ = this.var_119.getValue(AvatarType.const_138) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_119.getValue(AvatarType.const_138) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1092)
         {
            if(this.var_2458 && this.var_2459 && this.var_2460)
            {
               this.var_1092 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_119.getValue(AvatarType.const_138) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1848)
         {
            this.var_1848 = new AvatarFigureContainer(this.const_2346);
         }
         this.var_247.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1848,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc2_ in this.var_326.getKeys())
         {
            _loc3_ = this.var_326.getValue(_loc2_);
            if(_loc3_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1802)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_119.getValue(AvatarType.const_138) as AvatarStructure;
