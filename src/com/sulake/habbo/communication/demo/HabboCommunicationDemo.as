package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_537:IKeyExchange;
      
      private var var_978:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2414:PseudoRandom;
      ...
      private var var_243:HabboHotelView;
      
      private var var_1492:String = "";
      
      private const const_2071:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_632 = param1;
            this.var_63.method_3(HabboConnectionType.const_264);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_63 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_63.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_63.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_63.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_63.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_63.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_63.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_63.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_63.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_63.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_63.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_63.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_63.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_63.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_63 && this.var_153 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_243 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         ...
         {
            this.var_243.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_153.getKey("use.sso.ticket") == "1";
         this.var_632 = this.var_153.getKey("sso.ticket",null);
         this.var_1819 = this.var_153.getKey("flash.client.url","");
         this.var_2413 = this.var_153.getKey("external.variables.txt","");
         if(this.var_243 == null)
         {
            this.var_243 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_63.mode = HabboConnectionType.const_97;
            if(this.var_632)
            {
               this.var_63.method_3(HabboConnectionType.const_264);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_949,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1842);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_63.mode = HabboConnectionType.const_1394;
            }
         }
         this.var_63.method_3(HabboConnectionType.const_264);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_63.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_1009);
            _loc3_ = new InitCryptoMessageComposer(this.var_63.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2414 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_63.mode)
         {
            case HabboConnectionType.const_97:
               ...
               this.var_1492 = _loc4_;
               this.var_243.loadBannerImage(_loc7_ + "?token=" + this.var_1492,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1394:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1814:
               this.var_978 = this.generateRandomHexString(30);
               this.var_537 = new DiffieHellman(new BigInteger(this.var_153.getKey("connection.development.prime"),16),new BigInteger(this.var_153.getKey("connection.development.generator"),16));
               this.var_537.init(this.var_978);
               _loc8_ = this.var_537.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_63.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_537.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_537.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2414);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1493 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_278);
         connection.send(new VersionCheckMessageComposer(401,this.var_1819,this.var_2413));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2071,"/");
      ...
      {
         var _loc4_:IConnection = this.var_63.getHabboMainConnection(null);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_306);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2415)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1492);
         ...
         var _loc9_:IConnection = this.var_63.getHabboMainConnection(null);
         ...
         this.var_537 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_537.init(_loc14_);
            _loc15_ = this.var_537.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_978 = _loc14_;
            }
