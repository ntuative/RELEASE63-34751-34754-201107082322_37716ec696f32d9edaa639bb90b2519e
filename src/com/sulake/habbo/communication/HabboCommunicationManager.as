package com.sulake.habbo.communication
{
   ...
   public class HabboCommunicationManager extends Component implements IHabboCommunicationManager, IConnectionStateListener
   {
      ...
      private const const_2356:int = 2;
      ...
      {
         if(this.var_396.length == 0 || this.var_457 < 0 || this.var_457 >= this.var_396.length)
         {
            return 0;
         }
         return this.var_396[this.var_457];
      }
      ...
      private function onCoreCommunicationManagerInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_283.registerProtocolType(HabboProtocolType.const_1224,WedgieProtocol);
            this._connection = this.var_283.createConnection(HabboConnectionType.const_264,ConnectionType.const_1308);
            _loc3_ = this.var_283.getProtocolInstanceOfType(HabboProtocolType.const_1224);
      ...
      public function method_3(param1:String) : void
      {
         switch(param1)
         {
            case HabboConnectionType.const_264:
      ...
      private function nextPort() : void
      {
         ...
         ++this.var_457;
         if(this.var_457 >= this.var_396.length)
         {
            ErrorReportStorage.addDebugData("ConnectionRetry","Connection attempt " + this.var_1035);
            ++this.var_1035;
            _loc1_ = this.const_2356;
            if(this.var_396.length == 1)
            {
               _loc1_++;
            }
            if(this.var_1035 > _loc1_)
            {
               if(this.var_2640)
               {
                  return;
         ...
         this._connection.timeout = this.var_1035 * 10000;
         this._connection.init(this.var_39 + this.getKey([[65244,65185,65191,65189,65188],[65174,65238,65184],[65171,65172]],0),this.var_396[this.var_457]);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication IO Error","IOError " + param1.type + " on connect: " + param1.text + ". Port was " + this.var_396[this.var_457]);
         this.tryNextPort();
      }
      
      private function onConnect(param1:Event) : void
      {
         ErrorReportStorage.addDebugData("Connection","Connected with " + this.var_1035 + " attempts");
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication Security Error","SecurityError on connect: " + param1.text + ". Port was " + this.var_396[this.var_457]);
         this.tryNextPort();
      }
      
      public function getHabboMainConnection(param1:Function) : IConnection
      {
         return !!this.var_283 ? this.var_283.queueConnection(HabboConnectionType.const_264,param1) : null;
      }
      ...
      public function addHabboConnectionMessageEvent(param1:IMessageEvent) : void
      {
         if(this.var_283)
         {
            this.var_283.addConnectionMessageEvent(HabboConnectionType.const_264,param1);
         }
      }
      ...
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1735,param1);
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1729,String(param2));
      }
      
      public function messageReceived(param1:String, param2:String) : void
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1925,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2017,param1 + " " + param2);
      ...
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2013,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1828,param1 + " " + param2);
         if(this.var_157.length > 0)
         {
