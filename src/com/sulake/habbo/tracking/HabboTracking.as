package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1152:uint = 11;
      ...
      private var var_235:IHabboFriendList;
      
      private var var_1383:IHabboWindowManager;
      ...
      private var var_486:FramerateTracker = null;
      
      private var var_299:LatencyTracker = null;
      
      private var var_733:LagWarningLogger = null;
      
      private var var_485:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_486 = new FramerateTracker();
         this.var_299 = new LatencyTracker();
         this.var_733 = new LagWarningLogger();
         this.var_485 = new ToolbarClickTracker(this);
         this.var_1671 = new Array(const_1152);
         var _loc4_:int = 0;
         while(_loc4_ < const_1152)
         {
            this.var_1671[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1947,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1727,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1833,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_766,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1384,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1383)
            {
               this.var_1383.release(new IIDHabboWindowManager());
               this.var_1383 = null;
            }
            if(this.var_325)
            {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_350,this.onZoomToggle);
               }
            ...
            if(this.var_235)
            {
               ...
               {
                  Component(this.var_235).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_235).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_235).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_235).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_235).events.removeEventListener(HabboFriendListTrackingEvent.const_563,this.onFriendlistTrackingEvent);
               }
               this.var_235.release(new IIDHabboFriendList());
               this.var_235 = null;
            }
            if(this.var_197)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_225,this.onRoomAdClick);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_188,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_339,this.onRoomAction);
               }
            ...
            {
               this.var_352.stop();
               this.var_352.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_352 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_128)
         {
            if(this.var_299 != null)
            {
               this.var_299.configuration = this.var_128;
            }
            if(this.var_300 != null)
            {
               this.var_300.configuration = this.var_128;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1962);
            if(this.var_128)
            {
               if(this.var_733 != null)
               {
                  this.var_733.configure(this.var_128);
               }
               if(this.var_486 != null)
               {
                  this.var_486.configure(this.var_128);
               }
               if(this.var_485 != null)
               {
                  this.var_485.configure(this.var_128);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_1009,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_306,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_876,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_76,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_505,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_733 != null)
            {
               this.var_733.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_876)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1818);
         }
         else if(param1.type == HabboHotelViewEvent.const_505)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1923);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1898);
               break;
            case HabboCommunicationEvent.const_1009:
               this.trackLoginStep(HabboLoginTrackingStep.const_2034,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_223:
               ...
               break;
            case HabboCommunicationEvent.const_306:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_306);
               if(this.var_299 != null)
               {
                  this.var_299.init();
               }
      ...
      {
         this.var_1383 = IHabboWindowManager(param2);
         if(this.var_1383)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_128)
            {
               if(this.var_128.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1671)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1199);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1199,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_350,this.onZoomToggle);
      }
      ...
      {
         this.var_235 = param2 as IHabboFriendList;
         Component(this.var_235).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_235).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_235).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_235).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_235).events.addEventListener(HabboFriendListTrackingEvent.const_563,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_563:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2993)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1867);
            this.var_2993 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1384,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_766,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_225,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_188,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_339,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_325 = param2 as IAdManager;
         this.var_325.events.addEventListener(AdEvent.const_655,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_188)
         {
            if(this.var_2150 < 1)
            {
               if(!this.var_352)
               {
                  this.var_352 = new Timer(60000,1);
                  this.var_352.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_352.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_339)
         {
            if(this.var_352)
            {
               this.var_352.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_486)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_486.frameRate),_loc2_);
                  ++this.var_2150;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_485)
         {
            this.var_485.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_485)
         {
            this.var_485.track(param1.type);
         }
      }
      ...
      {
         this.var_733.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_593 > -1 && _loc2_ < this.var_593)
         {
            ++this.var_2149;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2149);
         }
         if(this.var_593 > -1 && _loc2_ - this.var_593 > 15000)
         {
            ++this.var_2151;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2151);
         }
         this.var_593 = _loc2_;
         if(this.var_300 != null)
         {
            this.var_300.update(param1,this.var_593);
         }
         if(this.var_299 != null)
         {
            this.var_299.update(param1,this.var_593);
         }
         if(this.var_486 != null)
         {
            this.var_486.trackUpdate(param1,this,this.var_593);
         }
         if(this.var_733 != null)
         {
            this.var_733.update(this.var_593);
         }
      }
   }
}
