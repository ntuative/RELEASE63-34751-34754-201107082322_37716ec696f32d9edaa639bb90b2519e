package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_673,this.onTaskDoneEvent);
         if(this.var_35.sessionDataManager != null)
         {
            this.var_35.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_365,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1177 && this.var_1176 && this.var_1459;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            ...
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_673,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
               this.var_35.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_365,this.onFigureUpdate);
            }
            this.var_35 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_547:
               this.var_1459 = true;
               if(this.var_53 != null && this.var_53.id == const_587)
               {
                  this.showView(const_95);
               }
               break;
      ...
      public function showView(param1:String) : void
      {
         ...
         this._window.height = _loc2_.height + this.var_2322;
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_53 != null && (this.var_53.id == const_322 || this.var_53.id == const_95))
         {
            this.showView(const_95);
         }
      }
      ...
      {
         this.var_1177 = true;
         if(this.var_53 != null && (this.var_53.id == const_405 || this.var_53.id == const_95))
         {
            this.showView(const_95);
         }
      }
