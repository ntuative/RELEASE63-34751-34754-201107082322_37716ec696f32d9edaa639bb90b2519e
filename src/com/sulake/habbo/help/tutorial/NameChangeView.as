package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1444:uint = 13232628;
      
      private static var var_1723:uint = 11129827;
      ...
      private var var_1164:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1725 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_762)
         {
            this.var_762 = this.var_26.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_762)
            {
               return;
            }
            this._window.content.addChild(this.var_762);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_761)
         {
            this.var_761 = this.var_26.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_761)
            {
               return;
            }
            this._window.content.addChild(this.var_761);
         }
         this._window.caption = this.var_26.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_761.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_516;
         }
         this.showView(this.var_761);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_26.localization.registerParameter("help.tutorial.name.available","name",this.var_516);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         this.var_1164 = new NameSuggestionListRenderer(this.var_26);
         var _loc6_:int = this.var_1164.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1444;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_516 = this.var_26.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this.var_26.changeName(this.var_516);
               break;
            ...
            case "header_button_close":
               this.var_26.showView(TutorialUI.const_95);
         }
      }
