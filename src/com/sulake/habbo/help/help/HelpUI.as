package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1802:String = "HHVE_HELP_FRONTPAGE";
      ...
      {
         this.var_375 = this.var_1802;
         this.var_533 = new Array();
         this.var_630 = new Array();
         super();
         this.var_22 = param1;
         this._assetLibrary = param2;
         this._windowManager = param3;
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201107082306));
         this.var_127 = new Map();
         this.var_127.add(HabboHelpViewEnum.const_2029,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_217,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_501,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_337,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_274,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_420,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_858,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_249,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_127.add(HabboHelpViewEnum.const_1185,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_127.add(HabboHelpViewEnum.const_1286,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_1027,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_533.length == 0 || param1 != this.var_375)
            {
               this.var_533.push(this.var_375);
            }
         }
         this.var_375 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_249:
               ...
               break;
            case CallForHelpResultEnum.const_1228:
               this.showUI(HabboHelpViewEnum.const_1286);
               break;
            case CallForHelpResultEnum.const_1189:
               this.showUI(HabboHelpViewEnum.const_1185);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_127.getValue(HabboHelpViewEnum.const_217) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_547));
      }
      ...
      {
         return this.var_127.getValue(this.var_375);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2321 = this._window.width - _loc3_.width;
         this.var_2322 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2322;
         this._window.width = _loc1_.width + this.var_2321;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_533.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_375 == HabboHelpViewEnum.const_217)
         {
            return;
         }
         if(this.var_630.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_630.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_630[1],this.var_630[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_630[0],this.var_630[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_375 == HabboHelpViewEnum.const_217 || this.var_533.length == 0)
         {
            return;
         }
         if(this.var_374 == null)
