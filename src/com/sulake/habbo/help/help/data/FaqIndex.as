package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_875:FaqCategory;
      ...
      {
         super();
         this.var_875 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_873 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_874 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_875.hasItem(param1))
         {
            this.var_875.getItem(param1).answerText = param2;
         }
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_875.hasItem(param1))
         {
            return this.var_875.getItem(param1);
         }
         if(this.var_873.hasItem(param1))
         {
