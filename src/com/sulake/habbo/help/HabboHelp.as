package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_1020:IHabboConfigurationManager;
      
      private var var_379:ISessionDataManager;
      
      private var var_1259:FaqIndex;
      ...
      private var var_829:HotelMergeUI;
      
      private var var_1540:CallForHelpData;
      
      private var var_2588:UserRegistry;
      
      private var var_2589:String = "";
      
      private var var_1021:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1540 = new CallForHelpData();
         this.var_2588 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1259 = new FaqIndex();
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_1020.getKey(param1,param2,param3);
      }
      ...
      public function reportUser(param1:int, param2:String) : void
      {
         ...
         this.var_74.showUI(HabboHelpViewEnum.const_420);
      }
      ...
      public function initHotelMergeUI() : void
      {
         if(!this.var_829)
         {
            this.var_829 = new HotelMergeUI(this);
         }
         this.var_829.startNameChange();
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_120)
         {
            this.var_120.showView(TutorialUI.const_322);
         }
      }
      ...
      {
         this.var_1020 = IHabboConfigurationManager(param2);
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         if(!this.var_1021)
         {
            this.var_1021 = new WelcomeScreenController(this,this._windowManager);
         }
         this.var_1021.showWelcomeScreen(param1);
      }
