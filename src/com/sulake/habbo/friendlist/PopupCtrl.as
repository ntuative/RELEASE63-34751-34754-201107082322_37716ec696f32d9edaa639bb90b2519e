package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(this.var_60 == null)
         {
            this.var_60 = IWindowContainer(this._friendList.getXmlWindow(this.var_1154));
         ...
         this.var_60.x = _loc4_.x - _loc3_.x + this.var_2567 + param2.width;
