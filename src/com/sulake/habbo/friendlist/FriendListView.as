package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1440:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2047:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2047 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1440;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1075 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_273 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_2047.prepare(this.var_1075);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1271,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1399,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_879,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_912,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_879,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_912,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.method_10;
         this.var_1617 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1617.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2046 == -1 ? 0 : int(this.var_16.height - this.var_2046);
         var _loc4_:int = this.var_2048 == -1 ? 0 : int(this.var_16.width - this.var_2048);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_273.y = Util.getLowestPoint(this.var_16.content);
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1177,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_879,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1271,false);
         ...
         this.var_2046 = this.var_16.height;
         this.var_2048 = this.var_16.width;
