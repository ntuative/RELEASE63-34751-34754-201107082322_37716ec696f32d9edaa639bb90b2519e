package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_161:IHabboMessenger;
      
      private var var_128:IHabboConfigurationManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_606:IAvatarRenderManager;
      
      private var var_781:ISessionDataManager;
      
      private var var_2355:FriendListLookAndFeel;
      
      private var var_468:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1777:OpenedToWebPopup;
      
      private var var_2356:int;
      
      var var_118:FriendCategories;
      
      private var var_124:FriendRequests;
      
      private var var_1778:AvatarSearchResults;
      ...
      {
         this.var_2355 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_118 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1778 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_626.stop();
            this.var_626.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_626 = null;
         }
         ...
         if(this.var_161)
         {
            this.var_161.release(new IIDHabboMessenger());
            this.var_161 = null;
         }
         if(this.var_128)
         {
         ...
         if(this.var_781)
         {
            this.var_781.release(new IIDSessionDataManager());
            this.var_781 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1777 = new OpenedToWebPopup(this);
         }
         this.var_1777.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_397);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_342,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_606.createAvatarImage(param1,AvatarScaleType.const_117,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_161 = param2 as IHabboMessenger;
      ...
      {
         this.var_1012 = param2 as IHabboNotifications;
      ...
      {
         this.var_781 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_124 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_118.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_1314,this.getText("friendlist.friends")));
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_454,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_118.addFriend(new Friend(_loc4_));
         }
         this.var_468 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_626)
         {
            this.var_626 = new Timer(120000);
            this.var_626.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_626.start();
         }
         ...
         {
            _loc5_ = this.var_118.findCategory(FriendCategory.const_454);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_124.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_124.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_468.findTab(FriendListTab.const_92).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:FriendRequest = new FriendRequest(_loc2_.method_4);
         this.var_124.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_468.findTab(FriendListTab.const_92);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1778.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_468.findTab(FriendListTab.const_92);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_468.findTab(FriendListTab.const_92);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_781 || !this.var_124)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_781.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_41))
         {
            _loc2_ = this.var_124.vipLimit;
         }
         else if(this.var_781.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_35))
         {
            _loc2_ = this.var_124.clubLimit;
         }
         if(_loc2_ > this.var_124.limit)
         {
            this.var_124.limit = _loc2_;
         }
      }
