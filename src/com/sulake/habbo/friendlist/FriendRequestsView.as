package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2079:String = "no_reqs_info";
      ...
      private var var_1892:IContainerButtonWindow;
      
      private var var_1891:IContainerButtonWindow;
      ...
      {
         this.var_1892 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1891 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1891.procedure = this.onDismissAllButtonClick;
         this.var_1892.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_195)
         {
         ...
         else if(param1.state == FriendRequest.const_1237)
         {
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_411 && _loc2_.state != FriendRequest.const_409)
            {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_229,param1));
         }
      }
      ...
      public function declineAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_411 && _loc2_.state != FriendRequest.const_409)
            {
               ...
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_229,_loc2_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1892,_loc1_);
         this.setEnabled(this.var_1891,_loc1_);
      }
