package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2127:int = "F".charCodeAt(0);
      
      public static const const_2264:int = "M".charCodeAt(0);
      ...
      private var var_1280:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_997 = param1.gender;
         this.var_858 = param1.online;
         this.var_1847 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1953 = param1.motto;
         this.var_1955 = param1.lastAccess;
         this.var_1537 = param1.categoryId;
         this.var_1954 = param1.realName;
