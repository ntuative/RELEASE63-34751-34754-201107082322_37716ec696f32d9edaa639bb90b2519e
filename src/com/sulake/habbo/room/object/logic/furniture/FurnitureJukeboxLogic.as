package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_548,RoomObjectFurnitureActionEvent.const_642,RoomObjectFurnitureActionEvent.const_660,RoomObjectFurnitureActionEvent.const_521,RoomObjectWidgetRequestEvent.const_173];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_827) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_445,RoomWidgetInfostandExtraParamEnum.const_571);
      ...
      private function requestStopPlaying() : void
      {
         ...
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_642,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
      ...
      private function requestDispose() : void
      {
         ...
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_660,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
   }
}
