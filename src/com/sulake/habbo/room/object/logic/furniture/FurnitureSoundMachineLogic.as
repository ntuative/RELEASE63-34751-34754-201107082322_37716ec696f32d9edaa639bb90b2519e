package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_577,RoomObjectFurnitureActionEvent.const_675,RoomObjectFurnitureActionEvent.const_657,RoomObjectFurnitureActionEvent.const_558];
      ...
      private function requestStopPlaying() : void
      {
         ...
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_675,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
