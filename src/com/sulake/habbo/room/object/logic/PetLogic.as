package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_152,RoomObjectMoveEvent.const_422];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2555)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1535 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_263,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_230);
            _loc2_.setString(RoomObjectVariableEnum.const_230,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1972,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_788,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(param1.type)
         {
            case MouseEvent.CLICK:
               ...
               if(eventDispatcher != null)
               {
                  _loc8_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.const_152,param1.eventId,_loc6_,_loc7_,param1.altKey,param1.ctrlKey,param1.shiftKey,param1.buttonDown);
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_205,_loc3_ + this.var_1014);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1898;
            _loc2_.setNumber(RoomObjectVariableEnum.const_257,this.var_1898);
            _loc2_.setNumber(RoomObjectVariableEnum.const_162,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1899;
            _loc2_.setNumber(RoomObjectVariableEnum.const_162,this.var_1899);
         }
         else
         {
            this.var_1014 += 45;
