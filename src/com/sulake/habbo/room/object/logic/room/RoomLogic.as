package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1607:uint = 16777215;
      
      private var var_2034:int = 255;
      
      private var var_1328:uint = 16777215;
      
      private var var_2033:int = 255;
      
      private var var_1329:int = 0;
      
      private var var_2032:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_609,RoomObjectMouseEvent.const_152];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_913,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_936,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1022,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_907,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1008,1);
         }
      }
         ...
         if(this.var_1608)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_913,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1302,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1329)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1852;
            if(_loc2_ - this.var_1329 >= this.var_2032)
            {
               _loc3_ = this.var_1328;
               _loc4_ = this.var_2033;
               this.var_1329 = 0;
            }
            else
            {
               _loc7_ = this.var_1607 >> 16 & 255;
               _loc8_ = this.var_1607 >> 8 & 255;
               _loc9_ = this.var_1607 & 255;
               _loc10_ = this.var_1328 >> 16 & 255;
               _loc11_ = this.var_1328 >> 8 & 255;
               _loc12_ = this.var_1328 & 255;
               _loc13_ = (_loc2_ - this.var_1329) / this.var_2032;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2034 + (this.var_2033 - this.var_2034) * _loc13_;
               this._color = _loc3_;
               this.var_1852 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_936,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_798:
            ...
            case RoomObjectRoomUpdateMessage.const_902:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_935:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_630:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_295)
               {
                  _loc5_ = "null";
               }
               this.var_526.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_910:
               _loc4_ = this.var_526.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_526.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1362,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1347:
               param2.setNumber(RoomObjectVariableEnum.const_1022,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1178:
               param2.setNumber(RoomObjectVariableEnum.const_907,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_1008,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_723:
               param2.setNumber(RoomObjectVariableEnum.const_1220,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1300:
               param2.setNumber(RoomObjectVariableEnum.const_1388,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_165:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1327,int(param1.bgOnly));
         this.var_1607 = this._color;
         this.var_2034 = this.var_1852;
         this.var_1328 = _loc3_;
         this.var_2033 = _loc4_;
         this.var_1329 = getTimer();
         this.var_2032 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_579,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1748,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1758,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1853,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_579,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_282 || _loc12_ == RoomPlaneData.const_423)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
