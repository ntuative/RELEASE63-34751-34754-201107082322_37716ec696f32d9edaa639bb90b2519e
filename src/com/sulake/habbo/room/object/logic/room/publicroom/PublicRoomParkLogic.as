package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1536:String = "goawaybus";
      
      private static const const_1535:String = "bus";
      
      private static const const_1537:String = "bus_oviopen_hidden";
      ...
      {
         var _loc1_:Array = [RoomObjectRoomActionEvent.const_652,RoomObjectRoomActionEvent.const_646];
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               switch(_loc3_.spriteTag)
               {
                  ...
                  case const_1535:
                  case const_1537:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_646,0,_loc4_,_loc5_);
               }
         }
