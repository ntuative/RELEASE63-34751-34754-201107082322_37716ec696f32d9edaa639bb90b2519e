package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1533:String = "head";
      
      private static const const_701:int = 1;
      
      private static const const_1086:int = 1000;
      
      private static const const_1531:String = "pet_experience_bubble_png";
      ...
      private var var_394:ExperienceData;
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_1029 = [];
         super();
         while(this.var_133.length < ANIMATION_INDEX_COUNT)
         {
            this.var_133.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_133 != null)
         {
            ...
            {
               _loc2_ = this.var_133[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1531) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_394 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2621)
            {
               this.var_2621 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_257);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_162);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_257);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_2072 = _loc3_.getNumber(RoomObjectVariableEnum.const_263) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_205);
            if(!isNaN(_loc8_))
            {
               this.var_1924 = _loc8_;
            }
            else
            {
               this.var_1924 = direction;
            }
            this.var_1547 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2378 = _loc3_.getNumber(RoomObjectVariableEnum.const_396);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_788);
            if(_loc9_ != this.var_1923)
            {
               this.var_1923 = _loc9_;
               this.var_2620 = this.var_1923.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         {
            this.var_394.alpha = 0;
            if(this.var_1547 > 0)
            {
               _loc2_ = param1 - this.var_1547;
               if(_loc2_ < const_1086)
               {
                  this.var_394.alpha = int(Math.sin(_loc2_ / const_1086 * 0) * 255);
                  this.var_394.setExperience(this.var_2378);
               }
               else
               {
                  this.var_1547 = 0;
               ...
               if(_loc3_ != null)
               {
                  if(this.var_394.alpha > 0)
                  {
                     _loc3_.asset = this.var_394.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_394.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_292)
         {
            ...
            this.setAnimationForIndex(const_1532,_loc3_);
         }
         if(param2 != this.var_1604)
         {
            this.var_1604 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_103,param2);
            this.setAnimationForIndex(const_1534,_loc3_);
         }
      }
      ...
      {
         return super.getAdditionalSpriteCount() + const_701;
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 >= 0 && param1 < this.var_133.length)
         {
            return this.var_133[param1];
         }
         return null;
      }
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1548 = false;
         var _loc1_:int = this.var_133.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_133[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function getFrameNumber(param1:int, param2:int) : int
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:int = this.var_133.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_133[_loc3_];
            if(_loc4_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_133.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_133[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2620);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_701)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_701))
            {
               if(param2 >= FurnitureVisualizationData.const_619.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_619[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1924);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_103,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1533)
            {
               this.var_1029[param1] = true;
            }
            else
            {
               this.var_1029[param1] = false;
            }
         }
         return this.var_1029[param1];
      }
   }
}
