package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_705:PetVisualizationData = null;
      ...
      private var var_2022:Number = NaN;
      ...
      {
         this.var_705 = param1 as PetVisualizationData;
         createSprites(this.const_1617);
         var _loc2_:BitmapData = (this.var_705.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
         this.var_394 = new ExperienceData(_loc2_.clone());
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_2072 = param1.getNumber(RoomObjectVariableEnum.const_263) > 0;
            this.var_1604 = param1.getString(RoomObjectVariableEnum.const_162);
            this.var_292 = param1.getString(RoomObjectVariableEnum.const_257);
            this.var_1631 = param1.getString(RoomObjectVariableEnum.const_1023);
            this.var_2022 = param1.getNumber(RoomObjectVariableEnum.const_205);
            this.var_1547 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2378 = param1.getNumber(RoomObjectVariableEnum.const_396);
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_508 != param1.getUpdateID() || this.var_1770 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_2022;
            if(isNaN(this.var_2022))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_2066 || param3)
            {
               this.var_2066 = _loc4_;
               _loc4_ -= 112.5;
               _loc4_ = (_loc4_ + 360) % 360;
               this.var_67.setDirectionAngle(AvatarSetType.const_42,_loc4_);
            }
            if(_loc5_ != this.var_2069 || param3)
            {
               this.var_2069 = _loc5_;
               _loc5_ -= 112.5;
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_705.getAvatar(this._figure,param1,this);
            if(_loc3_ != null)
            {
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_707 = null;
         _loc2_ = getSprite(this.const_2086);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc10_ || _loc7_ != var_103 || this.var_67 == null)
         {
            if(_loc7_ != var_103)
            {
               var_103 = _loc7_;
         ...
         var _loc12_:Boolean = this.var_977 || this.var_1323 > 0 || this.var_2021;
         this.var_394.alpha = 0;
         if(this.var_1547 > 0)
         {
            _loc13_ = param2 - this.var_1547;
            if(_loc13_ < AvatarAction.const_1086)
            {
               this.var_394.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_394.setExperience(this.var_2378);
               this.var_1323 = this.const_2367;
            }
            else
            {
               this.var_1547 = 0;
            }
            _loc14_ = getSprite(this.const_2089);
            if(_loc14_ != null)
            {
               if(this.var_394.alpha > 0)
               {
                  _loc14_.asset = this.var_394.image;
                  _loc14_.offsetX = -20;
                  _loc14_.offsetY = -80;
                  _loc14_.alpha = this.var_394.alpha;
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_1123);
            if(_loc14_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1604 != null && this.var_1604 != "")
         {
            param1.appendAction(AvatarAction.const_344,this.var_1604);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1617;
