package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1906:String = "cone";
      
      public static const const_2031:String = "plane";
      
      public static const const_1759:String = "sphere";
      ...
      private var var_1112:Number = 0.1;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_415)
         {
            _loc1_.dispose();
         }
         this.var_415 = null;
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_298 = param6;
         this.var_2962 = param7;
         this.var_2965 = param9;
         this._energy = param8;
         this.var_2961 = param10;
         this.reset();
      }
      ...
      public function reset() : void
      {
         ...
         this.var_1111 = 0;
         this.var_1005 = false;
         this.init(0,0,0,this._direction,this.var_2960,this.var_1112,this.var_2965,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1373.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_1005 = true;
         if(this.var_1111 < this.var_1666)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2963)
         {
            switch(this.var_2962)
            {
               case const_1906:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1112,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_415.push(_loc4_);
            ++this.var_1111;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1373.length);
         return this.var_1373[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1111 < this.var_1666)
         {
            if(this.age % this.var_2961 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1111 < this.var_1666)
         {
            ...
            this.y = (2 - this.var_298) * this.y - (1 - this.var_298) * this.lastY + this.var_2135 * this.var_1112 * this.var_1112;
         ...
         var _loc1_:* = [];
         for each(_loc2_ in this.var_415)
         {
            _loc2_.update();
            _loc3_ = _loc2_.x;
            _loc4_ = _loc2_.y;
            ...
            _loc2_.y = (2 - this.var_298) * _loc2_.y - (1 - this.var_298) * _loc2_.lastY + this.var_2135 * this.var_1112 * this.var_1112;
