package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_2058:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2911:Number = NaN;
      
      private var var_2910:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1366:String = null;
      ...
      private var var_2907:Number = 0.0;
      ...
      private var var_2909:Number = 0.0;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1653 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1653;
            this.var_1653 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2477;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_508 != _loc3_.getUpdateID() || param1 != var_103 || param2 != this.var_2911)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2910 = _loc3_.getNumber(RoomObjectVariableEnum.const_292);
            ...
            this.var_1366 = this.getAdClickUrl(_loc3_);
            if(this.var_1366 == null || this.var_1366.indexOf("http") != 0)
            {
               this.var_1366 = null;
            }
            this.var_2477 = this.var_1366 != null;
            this.var_2909 = _loc3_.getNumber(RoomObjectVariableEnum.const_909);
      ...
      {
         if(this.var_2906 != param2 || this.var_2907 != param1)
         {
            this.var_1102 = [];
            this.var_1101 = [];
            this.var_889 = [];
            ...
            this.var_2908 = this.getSize(param1);
      ...
      {
         this.var_631 = param1;
         this.var_1652 = this.var_631 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_619.length)
         {
            return "";
         }
         ...
         {
            _loc5_ = this.var_2908;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1652)
            {
               _loc6_ = FurnitureVisualizationData.const_619[param2];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_893[param3] != null && !this.var_2104)
         {
      ...
      {
         if(this.var_890[param2] != null)
         {
            return this.var_890[param2];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         if(param3 != this.var_1652)
         {
            ...
            return LayerData.const_564;
         }
         return Math.ceil(this.var_2909 * (param1 / 2));
      }
