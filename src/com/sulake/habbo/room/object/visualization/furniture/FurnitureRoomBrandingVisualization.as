package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1540:String = "branded_image";
      
      private static const const_1542:int = 0;
      ...
      protected var var_1415:Boolean = false;
      
      protected var var_1703:int;
      
      protected var var_1702:int;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1703 = _loc4_.getNumber(RoomObjectVariableEnum.const_530);
                  this.var_1702 = _loc4_.getNumber(RoomObjectVariableEnum.const_588);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_626);
               }
            }
         }
         if(!this.var_1415)
         {
            this.var_1415 = this.checkIfImageReady();
            if(this.var_1415)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_326);
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_575);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1540)
         {
