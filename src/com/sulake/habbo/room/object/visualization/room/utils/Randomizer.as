package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2114:int = 16777216;
      ...
      private var var_1763:int = 16777216;
      
      private var var_3067:int = 69069;
      
      private var var_3068:int = 5;
      ...
      {
         var _loc1_:int = this.var_3067 * this.var_1764 + this.var_3068;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1763;
         this.var_1764 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1763 * param2);
      }
   }
}
