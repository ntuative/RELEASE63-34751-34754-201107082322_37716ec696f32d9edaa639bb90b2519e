package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1781:int = 16777215;
      
      public static const const_1909:int = 13421772;
      
      private static const const_1059:int = 16777215;
      
      private static const const_1056:int = 13421772;
      
      private static const const_1058:int = 10066329;
      
      private static const const_1057:int = 10066329;
      
      public static const const_1822:int = 16777215;
      
      public static const const_1772:int = 13421772;
      
      public static const const_1934:int = 10066329;
      ...
      private var var_779:Rectangle = null;
      
      private var var_526:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_1100:Number = NaN;
      
      private var var_1463:Number = NaN;
      
      private var var_2342:Number = NaN;
      
      private var var_1767:String = null;
      
      private var var_1181:uint = 16777215;
      
      private var var_2341:int = 255;
      
      private var var_2343:int = 255;
      
      private var var_2339:int = 255;
      ...
      private const const_2343:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_526 = new RoomPlaneBitmapMaskParser();
      ...
      private function resetRoomPlanes() : void
      {
         ...
         if(this.var_151 != null)
         {
            ...
            {
               _loc2_ = this.var_151[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_779 = super.boundingRectangle;
         }
         return new Rectangle(this.var_779.x,this.var_779.y,this.var_779.width,this.var_779.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_151.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_151[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1100))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1100;
         }
         if(!isNaN(this.var_1463))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1463;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_913);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1353);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_423)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1822;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1772;
               }
               else
               {
                  _loc13_.color = const_1934;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1845)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_73,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2343 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_371.length)
            {
               _loc11_ = this.var_624[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_371[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1768)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2339 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2343 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2341 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1770)
         {
            this.var_1770 = param1.updateId;
            this.var_779 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1552 || _loc3_.y != this.var_2344 || _loc3_.z != this.var_2340 || param1.scale != this.var_1769))
            {
               this.var_1552 = _loc3_.x;
               this.var_2344 = _loc3_.y;
               this.var_2340 = _loc3_.z;
               this.var_1769 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1362);
            if(_loc3_ != this.var_1767)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1767 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_936));
            if(_loc4_ != this.var_1181)
            {
               this.var_1181 = _loc4_;
               this.var_2339 = this.var_1181 & 255;
               this.var_2343 = this.var_1181 >> 8 & 255;
               this.var_2341 = this.var_1181 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1327));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_150 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_203);
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1022));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_907));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1008));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_150 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1220);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1388);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1100 || _loc3_ != this.var_1463))
            {
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_150 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1302);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2342)
            {
               this.var_2342 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_151.length)
         {
            _loc5_ = this.var_151[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_371;
         if(this.var_371.length == 0)
         {
            _loc6_ = this.var_151;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_371.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_371.push(_loc12_);
                        this.var_624.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1180;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_526.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_151.length)
         {
            _loc3_ = this.var_151[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_526.maskCount)
         {
            _loc10_ = this.var_526.getMaskType(_loc8_);
            _loc11_ = this.var_526.getMaskLocation(_loc8_);
            _loc12_ = this.var_526.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_151.length)
               {
                  _loc3_ = this.var_151[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_73 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_295)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_151[_loc18_] as RoomPlane;
