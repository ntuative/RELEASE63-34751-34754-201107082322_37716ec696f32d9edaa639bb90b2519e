package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      private var var_902:DirectionData = null;
      
      private var var_302:Map;
      
      private var _colors:Map;
      
      private var var_1386:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_902 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_302 != null)
         {
            ...
            {
               _loc2_ = this.var_302.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_902,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_302.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_902);
            this.defineDirection(_loc3_,_loc8_);
            this.var_302.add(String(_loc7_),_loc3_);
            this.var_2162 = -1;
            this.var_1386 = null;
            _loc5_++;
         }
         ...
         while(_loc4_ < param2.length())
         {
            ...
            switch(_loc8_)
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1272);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         ...
         if(this.var_302.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < this.var_302.length)
         {
            _loc6_ = int(this.var_302.getKey(_loc5_)) * this.var_1679;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_302.getKey(_loc4_));
         }
         return const_1917;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_302.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_902;
         }
