   ...
   public class AnimationSizeData extends SizeData
   {
      ...
      public function defineAnimations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_336.add(_loc6_,_loc9_);
            if(!_loc7_)
            {
               this.var_1580.push(_loc6_);
            }
            _loc4_++;
         }
         return true;
      ...
      public function getAnimationId(param1:int) : int
      {
         ...
         {
            return this.var_1580[param1 % _loc2_];
         }
         return 0;
      }
      ...
      {
         var _loc3_:AnimationData = this.var_336.getValue(param1) as AnimationData;
         if(_loc3_ != null)
         {
      ...
      {
         var _loc6_:* = null;
         var _loc5_:AnimationData = this.var_336.getValue(param1) as AnimationData;
         if(_loc5_ != null)
         {
      ...
      {
         var _loc8_:* = null;
         var _loc7_:AnimationData = this.var_336.getValue(param1) as AnimationData;
         if(_loc7_ != null)
         {
