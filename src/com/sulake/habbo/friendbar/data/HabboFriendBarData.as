package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1141:Boolean = false;
      
      private static const const_724:String = "Navigation";
      
      private static const const_725:String = "Friend Bar";
      
      private static const const_1671:String = "go.friendbar";
      
      private static const const_1670:String = "chat_btn_click";
      
      private static const const_1672:String = "find_friends_btn_click";
      
      private static const const_1139:String = "Toolbar";
      
      private static const const_1138:String = "open";
      
      private static const const_1140:String = "close";
      
      private static const const_1669:String = "FRIENDLIST";
      
      private static const const_1673:String = "MESSENGER";
       
      
      private var var_1108:IHabboConfigurationManager;
      
      private var var_95:IHabboCommunicationManager;
      
      private var var_91:IHabboFriendList;
      
      private var var_234:IHabboMessenger;
      
      private var var_722:IHabboEventStream;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_1108)
            {
               this.var_1108.release(new IIDHabboConfigurationManager());
               this.var_1108 = null;
            }
            if(this.var_95)
            {
            ...
            if(this.var_91)
            {
               ...
               {
                  this.var_91.events.removeEventListener(FriendRequestEvent.const_59,this.onFriendRequestEvent);
                  this.var_91.events.removeEventListener(FriendRequestEvent.const_229,this.onFriendRequestEvent);
               }
            ...
            if(this.var_234)
            {
               this.var_234.release(new IIDHabboMessenger());
               this.var_234 = null;
            }
            if(this.var_722)
            {
               this.var_722.release(new IIDHabboEventStream());
               this.var_722 = null;
            }
            this.var_115 = null;
      ...
      {
         return this.var_351.getValue(param1);
      }
      ...
      {
         var _loc3_:int = this.var_115.indexOf(param1);
         if(_loc3_ > -1 && _loc3_ != param2)
         {
            this.var_115.splice(_loc3_,1);
            this.var_115.splice(param2,0,param1);
      ...
      {
         return !!this.var_124 ? int(this.var_124.length) : 0;
      }
      
      public function getFriendRequestAt(param1:int) : FriendRequest
      {
         return !!this.var_124 ? this.var_124[param1] : null;
      }
      ...
      private function removeFriendRequest(param1:int) : void
      {
         ...
         if(this.var_124)
         {
            for each(_loc2_ in this.var_124)
            {
               if(_loc2_.id == param1)
               {
                  this.var_124.splice(this.var_124.indexOf(_loc2_),1);
                  events.dispatchEvent(new FriendRequestUpdateEvent());
                  return;
               }
            }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_95)
         {
            ...
            this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_724,const_725,const_1671));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_234)
         {
            this.var_234.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_95)
            {
               this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_724,const_725,const_1670));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_95)
         {
            ...
            this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_724,const_725,const_1672));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_91)
         {
            if(!this.var_91.disposed)
            {
               ...
               if(this.var_95)
               {
                  this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1139,const_1669,!!this.var_91.isOpen() ? const_1138 : const_1140));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_234)
         {
            ...
            {
               this.var_234.toggleMessenger();
               if(this.var_95)
               {
                  this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1139,const_1673,!!this.var_234.isOpen() ? const_1138 : const_1140));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_722)
         {
            if(!this.var_722.disposed)
            {
               this.var_722.visible = !this.var_722.visible;
            }
         }
      }
      ...
      {
         this.var_1108 = param2 as IHabboConfigurationManager;
         this.var_2939 = this.var_1108.getBoolean("friendbar.notifications.enabled",false);
         this.var_2124 = this.var_1108.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      private function onCommunicationManagerAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_95.addHabboConnectionMessageEvent(new FriendNotificationEvent(this.include));
      }
      
      private function onMessengerComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_234 = param2 as IHabboMessenger;
      }
      
      private function onOfflineStreamAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_722 = param2 as IHabboEventStream;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_91 = param2 as IHabboFriendList;
         this.var_91.events.addEventListener(FriendRequestEvent.const_59,this.onFriendRequestEvent);
         this.var_91.events.addEventListener(FriendRequestEvent.const_229,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_351.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_351.remove(_loc8_);
               this.var_115.splice(this.var_115.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_351.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_319)
            {
               ...
               this.var_115.splice(0,0,_loc3_);
               this.var_351.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_319)
            {
               if(this.var_351.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
         ...
         {
            this.var_115 = !!const_319 ? this.sortByNameAndOnlineStatus(this.var_115) : this.sortByName(this.var_115);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewFriendRequest(param1:NewBuddyRequestEvent) : void
      {
         ...
         if(this.var_2124)
         {
            _loc2_ = param1.getParser().method_4;
            this.var_124.push(new FriendRequest(_loc2_.requestId,_loc2_.requesterName,_loc2_.figureString));
            events.dispatchEvent(new FriendRequestUpdateEvent());
         }
      }
      ...
      private function onFriendRequestList(param1:BuddyRequestsEvent) : void
      {
         ...
         if(this.var_2124)
         {
            ...
            {
               this.var_124.push(new FriendRequest(_loc3_.requestId,_loc3_.requesterName,_loc3_.figureString));
            }
            events.dispatchEvent(new FriendRequestUpdateEvent());
         }
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_895 = _loc2_.senderId;
         var _loc3_:Boolean = true;
         if(this.var_234)
         {
            if(this.var_234.isOpen())
            {
               _loc4_ = this.var_234.getActiveConversation();
               if(_loc4_)
               {
                  if(_loc4_.id == this.var_895)
                  {
                     _loc3_ = false;
                  }
               }
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_895));
            this.makeNotification(String(this.var_895),FriendNotification.const_459,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_895 = _loc2_.senderId;
         if(this.var_234 && !this.var_234.isOpen())
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_895));
            this.makeNotification(String(this.var_895),FriendNotification.const_459,null,true,false);
         }
      }
      
      private function include(param1:FriendNotificationEvent) : void
      {
