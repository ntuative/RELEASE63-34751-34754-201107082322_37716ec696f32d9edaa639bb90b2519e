package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class Tab implements ITab
   {
      ...
      public static var var_2215:IHabboLocalizationManager;
      
      public static var var_2212:TextCropper;
      ...
      {
         if(this.disposed || this.method_2)
         {
            return;
         }
         if(this.selected)
      ...
      {
         if(this.disposed || this.method_2 || this._window == null)
         {
            return;
         }
         if(!this.selected)
