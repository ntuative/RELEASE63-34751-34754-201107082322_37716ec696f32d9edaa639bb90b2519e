package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2048:String = "badge_counter";
      
      protected static const const_2051:String = "button_accept_all";
      
      protected static const const_2049:String = "click_area_discard_all";
      ...
      protected static const const_1414:String = "text_discard";
      
      private static var var_1526:FriendRequestsTab;
      
      private static const const_75:uint = 4294625561;
      
      private static const const_1051:uint = 4294957414;
      
      private static const const_1620:uint = 4289431312;
      
      private static const const_1619:uint = 4290616362;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1526 ? var_1526 : new FriendRequestsTab();
         _loc2_.var_168 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_2048).caption = String(param1.length);
         return _loc2_;
      }
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_2036)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1332.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1620) : uint(const_1619);
                           _loc5_ = this._requests[_loc8_];
                           _loc4_.id = _loc5_.id;
                           _loc4_.getChildByName(const_718).caption = _loc5_.name;
      ...
      private function allocateRequestsTabWindow() : IWindowContainer
      {
         ...
         this.var_1332 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1414)).textColor = REGION_REJECT_COLOR_EXPOSED;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1037)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1414)).textColor = const_1506;
            }
         }
      }
