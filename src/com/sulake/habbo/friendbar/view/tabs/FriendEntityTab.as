package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1461:String = "entity_xml";
      
      private static const const_1460:String = "facebook_piece_xml";
      
      private static const const_1459:String = "controls_piece_xml";
      ...
      protected static const const_1410:String = "facebook";
      
      protected static const const_1409:String = "controls";
      
      protected static const const_315:String = "canvas";
      
      protected static const const_718:String = "name";
      
      protected static const const_1064:String = "btn_message";
      
      protected static const const_1030:String = "icon_message";
      
      protected static const const_1408:String = "btn_visit";
      
      protected static const ICON:String = "icon";
      
      protected static const const_1036:String = "label";
      
      protected static const const_491:String = "notification";
      
      private static const const_75:uint = 10338138;
      
      private static const const_1051:uint = 13891476;
      
      private static const const_1050:String = null;
      
      private static const const_685:String = "icon_tag_notify";
      
      private static const const_1462:String = "icon_tag_message";
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         ...
         _loc3_ = _loc2_.getListItemByName(const_1410) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         _loc3_ = _loc2_.getListItemByName(const_1409) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_491,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1460).content as XML) as IWindowContainer;
               _loc3_.name = const_1410;
               _loc6_ = _loc3_.getChildByName(const_718) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2212.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1459).content as XML) as IWindowContainer;
               _loc3_.name = const_1409;
               _loc8_ = _loc3_.getChildByName(const_1064);
               if(_loc8_)
               {
                  _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClick);
               }
               _loc8_ = _loc3_.getChildByName(const_1408);
               if(_loc8_)
               {
      ...
      {
         super.expose();
         _window.color = !!exposed ? uint(const_1051) : uint(const_75);
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_166)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1031)).getListItemByName(const_463) as IWindowContainer;
            _loc1_.findChildByName(const_718).caption = this.var_166.name;
            var_2212.crop(_loc1_.getChildByName(const_718) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_315));
            _loc2_.bitmap = var_502.getAvatarFaceBitmap(this.var_166.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_471.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1461).content as XML) as IWindowContainer;
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         switch(param1.typeCode)
         {
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2215);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_685;
               break;
            case FriendNotification.const_1275:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2215);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_685;
               break;
