package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      protected static const const_2044:String = "_alert_button_list";
      
      protected static const const_617:String = "_alert_button_ok";
      
      protected static const const_1035:String = "_alert_button_cancel";
      
      protected static const const_1297:String = "_alert_button_custom";
      
      protected static const const_1411:String = "header_button_close";
      
      protected static const const_1976:String = "_alert_text_summary";
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         var _loc7_:IItemListWindow = this._window.findChildByName(const_2044) as IItemListWindow;
         if(_loc7_)
         {
            if(!(param5 & 0))
            {
            ...
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_1297);
               _loc8_.dispose();
            }
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case const_617:
                  ...
                  {
                     _loc3_ = WindowEvent.allocate(WindowEvent.const_143,null,null);
               ...
               case const_1411:
                  if(this.var_313 != null)
                  {
                     _loc3_ = WindowEvent.allocate(WindowEvent.const_502,null,null);
                     this.var_313(this,_loc3_);
                     _loc3_.recycle();
                  }
                  else
         ...
         if(!this._disposed)
         {
            switch(param1)
            {
               case HabboAlertDialogFlag.const_617:
                  _loc2_ = this._window.findChildByName(const_617) as IInteractiveWindow;
                  break;
               case HabboAlertDialogFlag.const_1035:
                  _loc2_ = this._window.findChildByName(const_1035) as IInteractiveWindow;
                  break;
               case HabboAlertDialogFlag.const_1297:
                  _loc2_ = this._window.findChildByName(const_1297) as IInteractiveWindow;
            }
         }
      ...
      public function set summary(param1:String) : void
      {
         ...
         if(this._window)
         {
            ITextWindow(this._window.findChildByTag("DESCRIPTION")).text = this.var_1893;
         }
      }
