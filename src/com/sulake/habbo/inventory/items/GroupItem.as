package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1469:int = 13421772;
      
      private static const const_1468:int = 10275685;
      ...
      protected var var_3049:BitmapData;
      
      private var var_1527:Boolean;
      
      private const const_2075:Number = 1;
      
      private const const_2076:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2363 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_3049 = param6;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1660));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2248);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_997)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2076;
               _loc1_.blend = this.const_2076;
            }
            else
            {
               this._window.blend = this.const_2075;
               _loc1_.blend = this.const_2075;
            }
         }
         this.var_1525.color = !!this.var_1527 ? uint(const_1468) : uint(const_1469);
         this.var_2363.visible = this.isSelected;
