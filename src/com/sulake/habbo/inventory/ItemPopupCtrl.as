package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_1510:int = 250;
      
      private static const const_1508:int = 100;
      
      private static const const_1507:int = 180;
      
      private static const const_1509:int = 200;
      ...
      {
         this.var_389 = new Timer(const_1510,1);
         this.var_388 = new Timer(const_1508,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         this._assets = param2;
         this.var_389.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_389.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_389.stop();
            this.var_389 = null;
         }
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1507,param3.width),Math.min(const_1509,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1882);
         switch(this.var_1882)
         {
            case const_1175:
               this.var_93.x = -1 * this.var_93.width - const_1078;
               break;
            case const_662:
               this.var_93.x = this._parent.width + const_1078;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         switch(param1)
         {
            case const_1175:
               ...
               _loc2_.y = (this.var_93.height - this.var_1000.height) / 2;
