package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private static const const_481:int = 3;
      ...
      private var var_1656:IWindowContainer;
      
      private var var_2115:IWindowContainer;
      
      private const const_2072:Point = new Point(120,150);
      ...
      {
         return !!this.var_16 ? Boolean(this.var_16.getStateFlag(WindowState.const_88)) : false;
      }
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_26.inventoryViewOpened(this.var_894);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_411 != null && this.var_411 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_411 || !this.var_26.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_894);
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_411);
         }
         ...
         _loc2_.container.removeChild(this.var_2114);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_411 == InventoryCategory.const_131)
            {
               this.toggleCategoryView(InventoryCategory.const_131);
            }
            else if(this.var_411 == InventoryCategory.const_79)
            {
               this.toggleCategoryView(InventoryCategory.const_79);
            }
            else if(this.var_26 != null)
            {
               this.var_26.toggleInventoryPage(InventoryCategory.const_79);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_2115)
         {
            this.var_2115 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_26.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_2115,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_481;
            _loc3_.y = const_481;
         }
         return _loc3_;
      }
