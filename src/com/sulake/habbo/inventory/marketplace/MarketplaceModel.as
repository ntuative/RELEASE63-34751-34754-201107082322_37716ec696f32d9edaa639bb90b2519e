package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_26 != null && this.var_26.furniModel != null && this.var_242 != null)
         {
            this.var_26.furniModel.removeLockFrom(this.var_242.id);
            this.var_242 = null;
         }
      }
      ...
      public function getItemStats() : void
      {
         ...
         this.var_2384 = _loc2_;
         this.var_2381 = this.var_242.type;
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1797,this.var_1796);
         }
      }
      ...
      {
         if(param1 != this.var_2384 || param2 != this.var_2381)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2385);
      }
