package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1627:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_465 = [];
         this.var_466 = [];
         this.var_693 = new Timer(const_1627,1);
         this.var_693.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2827 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_161,this.onObjectPlaced);
               }
            ...
            {
               this.var_693.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_693.stop();
               this.var_693 = null;
            }
            if(this.var_230 != null)
            {
               this.var_230.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_230.stop();
               this.var_230 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         this.var_26.setInventoryCategoryInit(InventoryCategory.const_79);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_865 == null)
         {
            this.var_865 = this._windowManager.buildFromXML(this.var_2827) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_865.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_865.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_230 = new Timer(param1,1);
            this.var_230.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_230.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_79 && this.var_26.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_288:
                  this.var_26.toggleInventoryPage(InventoryCategory.const_131);
            }
         }
      }
      ...
      {
         this.var_26.checkCategoryInitilization(InventoryCategory.const_437);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_694.add(const_38,new Array());
         this.var_694.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      {
         return getTimer() < this.var_2828 + const_1628;
      }
      ...
      {
         return this.var_26.getSubCategoryViewId() == InventorySubCategory.const_377;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_324 || _loc3_.category == FurniCategory.const_373 || _loc3_.category == FurniCategory.const_353)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_694.getValue(param1) as Array;
         if(_loc3_ != null)
         {
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            ...
            case UnseenItemCategoryEnum.const_416:
               return this.var_466.length;
            default:
               return this.var_465.length + this.var_466.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            case const_45:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_416));
                  this.var_466 = [];
