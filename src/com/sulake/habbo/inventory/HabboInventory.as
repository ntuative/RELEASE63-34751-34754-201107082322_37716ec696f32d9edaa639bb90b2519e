package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2365:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_69,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_601,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_66.getValue(InventoryCategory.const_79));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_66.getValue(InventorySubCategory.const_377));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_66.getValue(InventoryCategory.const_142));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_66.getValue(InventorySubCategory.const_1258));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_66.getValue(InventoryCategory.const_131));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_66.getValue(InventoryCategory.const_437) as MarketplaceModel;
      }
      ...
      {
         return this.var_111.clubIsExpiring;
      }
      ...
      public function setClubStatus(param1:int, param2:int, param3:Boolean, param4:Boolean, param5:Boolean) : void
      {
         ...
         this.var_111.clubIsExpiring = param5;
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_69,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_601,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_86:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_601:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      private function initInventory() : void
      {
         ...
         this.var_66.add(InventoryCategory.const_437,_loc1_);
         ...
         this.var_66.add(InventoryCategory.const_79,_loc2_);
         ...
         this.var_66.add(InventoryCategory.const_142,_loc4_);
         ...
         this.var_66.add(InventorySubCategory.const_377,_loc5_);
         ...
         this.var_66.add(InventorySubCategory.const_1258,_loc6_);
         ...
         this.var_66.add(InventoryCategory.const_131,_loc7_);
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_377:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1074.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1074.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1074.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1074.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2365);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_253));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2800)
         {
            this.var_2800 = _loc1_;
