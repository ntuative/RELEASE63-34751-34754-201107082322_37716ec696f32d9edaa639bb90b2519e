package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1093:uint = 4284532064;
      
      private static const const_1094:uint = 2577770;
      ...
      private var var_674:ItemPopupCtrl;
      ...
      private var var_1061:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_674 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_225)
            {
               this.var_225.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_225.stop();
               this.var_225 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1968 = this.createMinimizedWindow();
         }
         if(!this.var_1155)
         {
            return this.var_79;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_79)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1093) : uint(const_1094);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1093) : uint(const_1094);
            }
         ...
         if(this.var_79)
         {
            ...
            switch(this.var_19.state)
            {
               ...
               case TradingModel.const_360:
                  ...
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_607:
                  _loc1_.disable();
                  this.showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_255:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_225 = new Timer(1000,3);
            this.var_225.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_225.reset();
         this.var_225.repeatCount = 3;
         this.var_225.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_225.currentCount));
         if(this.var_225.currentCount == 3)
         {
      ...
      public function removeSelection() : void
      {
         if(this.var_1061)
         {
            this.var_1061.isSelected = false;
            this.var_1061 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_2027)
            {
            ...
            this.var_674.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_662);
            this.var_674.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_674.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_200.push(param4);
            this.var_200.push(param1);
            this.var_200.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_200.length > 0)
         {
            _loc2_ = this.var_200.pop();
            _loc3_ = this.var_200.pop();
            _loc4_ = uint(this.var_200.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_674.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_662);
               }
            }
            else
            {
               this.var_200.push(_loc4_);
               this.var_200.push(_loc3_);
