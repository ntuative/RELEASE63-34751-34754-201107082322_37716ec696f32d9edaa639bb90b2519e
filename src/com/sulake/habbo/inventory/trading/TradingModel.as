package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_212:uint = 0;
      ...
      public static const const_255:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_59.updateItemList(this.var_849);
         this.var_59.updateItemList(this.var_1568);
      ...
      public function close() : void
      {
         if(this.var_834)
         {
            if(this._state != const_212 && this._state != const_255)
            {
      ...
      {
         this.var_59.setMinimized(param1 != InventoryCategory.const_79);
         this.var_12.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_848 + " OTHER: " + this.var_1290);
         ...
         {
            case const_212:
               if(param1 == const_226 || param1 == const_255)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_59.alertPopup(TradingView.const_1326);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_849)
            {
               this.var_848 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1290 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_59.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_849)
            {
               this.var_59.alertPopup(TradingView.const_1248);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_286.length < const_1931)
         {
