package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_44:
               this.var_1610.setSelectedGridItem(this);
               this.var_1609 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1609 = false;
                  this.var_1610.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1525)
         {
            return;
         }
         this.var_1525.color = !!this.var_1467 ? uint(const_1468) : uint(const_1469);
         this.var_2363.visible = param1;
      }
