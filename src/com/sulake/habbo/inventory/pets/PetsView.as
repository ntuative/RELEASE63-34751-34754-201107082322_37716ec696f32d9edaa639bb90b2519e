package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1054:int = 1;
      
      private const const_1074:int = 2;
      
      private const const_1076:int = 3;
      ...
      {
         var _loc2_:PetsGridItem = this.var_594.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_594 == null || this.var_594.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_594.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_594.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_594.add(param1.id,_loc2_);
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1054;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1074;
         }
         else
         {
            _loc2_ = this.const_1076;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_416) > 0;
