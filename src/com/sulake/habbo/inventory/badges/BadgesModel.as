package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public static const const_586:int = 0;
      ...
      private const const_2366:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_379 = param5;
         this.var_379.events.addEventListener(BadgeImageReadyEvent.const_233,this.onBadgeImageReady);
         this._view = new BadgesView(this,param2,param4);
         this.var_689 = [];
         this.var_1320 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_379.events.removeEventListener(BadgeImageReadyEvent.const_233,this.onBadgeImageReady);
            this.var_379 = null;
         }
      }
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_860[_loc2_] == param1)
            {
               this.var_860.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1320.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_689.indexOf(param3) != -1;
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_586);
      ...
      {
         return this.getItemInIndex(param1,const_586);
      }
      ...
      {
         if(param1 == InventoryCategory.const_235 && this.var_26.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_689.indexOf(_loc2_) == -1)
            {
               this.var_689.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_689 && this.var_689.length > 0)
         {
