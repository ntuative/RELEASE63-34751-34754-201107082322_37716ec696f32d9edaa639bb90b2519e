package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1662:int = 5;
      
      private static const const_1663:int = 10;
      
      private static const const_1665:int = 10;
      
      private static const const_1664:int = 30;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_795 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_795.toggle();
         this.var_2117 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1657.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1657[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_603 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_62.spacing = const_1663;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1665;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1662;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1664;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2117 && !this.var_2118)
            {
               this.var_2117 = false;
