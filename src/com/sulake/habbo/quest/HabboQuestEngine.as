package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1512:int = 15;
      
      private static const const_1514:int = 300;
      ...
      private var var_1001:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1001 = new AchievementController(this);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_379.events.removeEventListener(BadgeImageReadyEvent.const_233,this.var_1001.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_379.events.addEventListener(BadgeImageReadyEvent.const_233,this.var_1001.onBadgeImageReady);
      }
