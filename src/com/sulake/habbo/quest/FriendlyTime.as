package com.sulake.habbo.quest
{
   ...
   public class FriendlyTime
   {
      ...
      private static const const_1040:int = 3600;
      
      private static const const_1422:int = 3 * const_1041;
      
      private static const const_1421:int = 3 * const_1040;
      ...
      {
         if(param2 > const_1421)
         {
            return getLocalization(param1,"friendlytime.hours",Math.round(param2 / const_1040));
         }
         if(param2 > const_1422)
         {
            return getLocalization(param1,"friendlytime.minutes",Math.round(param2 / const_1041));
         }
