package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_1974:int = 5;
      
      private static const name_4:int = 0;
      
      private static const const_584:int = 1;
      ...
      private var var_1170:uint;
      
      private var var_1171:uint;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1738 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1738 = 15;
         }
         this.var_1737 = this._window.height;
         this.var_1451 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_584:
               ...
               _loc2_ = Number(this.var_1170) / Number(this.var_954["time_fade_in"]);
               if(this.var_1170 > int(this.var_954["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1053:
               ...
               if(this.var_1452 > int(this.var_954["time_display"]) && !this.var_1739)
               {
                  this.startFadeOut();
               }
               break;
            case const_1052:
               ...
               _loc3_ = 1 - Number(this.var_1171) / Number(this.var_954["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1171 > int(this.var_954["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1738;
         if(this._window.height < this.var_1737)
         {
            this._window.height = this.var_1737;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1974;
         this._window.y = this.var_1451;
      }
