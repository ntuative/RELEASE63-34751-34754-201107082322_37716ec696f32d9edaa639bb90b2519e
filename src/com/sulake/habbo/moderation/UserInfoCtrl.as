package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1149:int = 60;
      
      private static const const_1147:int = 3600;
      
      private static const const_1150:int = 86400;
      
      private static const const_1148:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1149)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1147)
         {
            return Math.round(param1 / const_1149) + " mins ago";
         }
         if(param1 < 2 * const_1150)
         {
            return Math.round(param1 / const_1147) + " hours ago";
         }
         if(param1 < 2 * const_1148)
         {
            return Math.round(param1 / const_1150) + " days ago";
         }
         return Math.round(param1 / const_1148) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1377.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_35.getXmlWindow("user_info"));
            this.var_1377.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1292,this._data.userId),this._callerFrame,this.var_1376,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1376,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1533),this._callerFrame,this.var_1376,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1533),this._callerFrame,this.var_1376,false,true);
      }
