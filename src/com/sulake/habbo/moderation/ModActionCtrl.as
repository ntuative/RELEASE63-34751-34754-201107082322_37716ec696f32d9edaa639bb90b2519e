package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1251:IDropMenuWindow;
      ...
      private var var_1007:OffenceCategoryData;
      
      private var var_1006:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1253 = IButtonWindow(this.var_35.getXmlWindow("modact_offence"));
         this.var_1252 = IButtonWindow(this.var_35.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1897;
         ...
         this.var_1251 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1251);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1007 != null;
         if(this.var_1006 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1006.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1007 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1007.offences,this.var_1253,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_35.initMsg.offenceCategories,this.var_1252,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_2026;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModAlertMessageComposer(this.var_1532,this.var_553.text,this.var_1533));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1007 = this.var_35.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1006 = this.var_1007.offences[_loc3_];
         this.var_553.text = this.var_1006.msg;
         this.var_648 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModKickMessageComposer(this.var_1532,this.var_553.text,this.var_1533));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1251.selection < 0)
         {
            this.var_35.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_35.connection.send(new ModBanMessageComposer(this.var_1532,this.var_553.text,this.getBanLength(),this.var_1533));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1251.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1253.destroy();
            this.var_1253 = null;
         }
         if(this.var_1252 != null)
         {
            this.var_1252.destroy();
            this.var_1252 = null;
         }
         this.var_1251 = null;
         this.var_553 = null;
