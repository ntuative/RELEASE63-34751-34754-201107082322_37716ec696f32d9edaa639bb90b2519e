package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_778:int = 4;
      
      public static const const_1292:int = 5;
      
      public static const const_1883:int = 6;
      
      public static const const_2026:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1870:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_1851[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1851[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
