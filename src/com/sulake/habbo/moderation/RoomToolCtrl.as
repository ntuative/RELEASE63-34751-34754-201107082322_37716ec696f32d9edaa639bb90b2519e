package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1262:IDropMenuWindow;
      
      private var var_553:ITextFieldWindow;
      
      private var var_648:Boolean = true;
      
      private var var_1025:ICheckBoxWindow;
      
      private var var_1541:ICheckBoxWindow;
      
      private var var_1542:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_373));
         Logger.log("BEGINNING TO SHOW: " + this.var_373);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1870;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_373);
         if(param1.flatId != this.var_373)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_373);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_553 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_553.procedure = this.onInputClick;
         this.var_1262 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1262);
         this.var_1262.procedure = this.onSelectTemplate;
         this.var_1025 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1541 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1542 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_778,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_648 || this.var_553.text == "")
         {
            this.var_35.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1025.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_2015,_loc2_,this.var_553.text,"",""));
         if(this.var_1541.isSelected || this.var_1542.isSelected || this.var_1025.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1541.isSelected,this.var_1542.isSelected,this.var_1025.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1827);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1763);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1262.selection];
         if(_loc3_ != null)
         {
            this.var_648 = false;
            this.var_553.text = _loc3_;
         }
      }
   }
}
