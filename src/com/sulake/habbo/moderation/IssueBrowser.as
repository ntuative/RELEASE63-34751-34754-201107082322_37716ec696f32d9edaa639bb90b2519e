package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_384:IIssueBrowserView;
      
      private var var_1857:IIssueBrowserView;
      
      private var var_1856:IIssueBrowserView;
      
      private var var_1858:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_276 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_276.numTabItems)
            {
               _loc5_ = this.var_276.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_48,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_276 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_276 == null || this.var_276.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_276.selector.getSelectableByName("open_issues");
         this.var_276.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_384 == _loc2_)
         {
            return;
         }
         if(this.var_384 != null)
         {
            this.var_384.visible = false;
         }
         this.var_384 = _loc2_;
         if(this.var_384 == null)
         {
         ...
         this.var_384.view.width = this.var_276.container.width;
         this.var_384.view.height = this.var_276.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2349:
               if(this.var_1857 == null)
               {
                  this.var_1857 = new MyIssuesView(this.issueManager,this,this.var_276.container);
               }
               return this.var_1857;
            case this.const_2348:
               if(this.var_1856 == null)
               {
                  this.var_1856 = new OpenIssuesView(this.issueManager,this,this.var_276.container);
               }
               return this.var_1856;
            case this.const_2347:
               if(this.var_1858 == null)
               {
                  this.var_1858 = new PickedIssuesView(this.issueManager,this,this.var_276.container);
               }
