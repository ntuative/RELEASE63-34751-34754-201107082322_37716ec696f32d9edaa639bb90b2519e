package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1282:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_562 = new UserInfoCtrl(this._window,this.var_75,_loc3_.message);
         this.var_1282 = new UserInfoCtrl(this._window,this.var_75,_loc3_.message);
         ...
         {
            this.var_1282.load(_loc4_,this.var_178.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_75 != null && this.var_75.issueManager != null && this.var_178 != null)
         {
            this.var_75.issueManager.removeHandler(this.var_178.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_75.issueManager.closeBundle(this.var_178.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_75.issueManager.closeBundle(this.var_178.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_75.issueManager.closeBundle(this.var_178.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_75.issueManager.releaseBundle(this.var_178.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_75.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_75,WindowTracker.const_1329,_loc2_),this._window,false,false,true);
      }
