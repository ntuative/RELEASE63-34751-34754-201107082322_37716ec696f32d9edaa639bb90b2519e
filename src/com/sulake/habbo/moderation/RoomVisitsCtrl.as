package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_2085:int = 200;
      ...
      {
         this.var_883 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1883;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_883.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1091.length < var_2085)
         {
            ...
            param1.width = this.var_883.width;
            param1.height = this.var_883.height;
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1646)
         {
