package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_808:IssueMessageData = null;
      
      private var var_809:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2464 = param2.pickerUserId;
         this.var_2463 = param2.pickerUserName;
         this.var_1689 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1235 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1234;
         }
         if(this.var_808 == null || param1.timeStamp < this.var_808.timeStamp)
         {
            this.var_808 = param1;
         }
         if(this.var_809 == null || param1.priority > this.var_809.timeStamp)
         {
            this.var_809 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_809;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_808;
         if(_loc2_ == null)
         {
