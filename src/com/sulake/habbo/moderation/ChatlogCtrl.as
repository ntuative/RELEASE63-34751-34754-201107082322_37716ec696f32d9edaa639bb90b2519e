package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_975:Array = [];
      
      private static var var_1815:int = 1000;
      
      private static var var_974:Array = [];
      
      private static var var_1817:int = 200;
      ...
      private var var_1733:IMessageComposer;
      ...
      {
         this.var_789 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_788 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         ...
         this.var_35.connection.send(this.var_1733);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_975.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_788.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_975.length < var_1815)
         {
            ...
            param1.width = this.var_788.width;
            param1.height = this.var_788.height;
            var_975.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_974.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_789.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_974.length < var_1817)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_789.width;
            param1.height = this.var_789.height;
            var_974.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1816[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1486.getValue(param2.chatterName))
            {
               this.var_1486.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1486.getValue(_loc2_);
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         var _loc2_:Boolean = this.method_6();
      }
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1488)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1487)
         {
