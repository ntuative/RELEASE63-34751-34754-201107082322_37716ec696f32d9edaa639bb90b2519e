package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_477:Conversations;
      
      private var var_205:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_128 && this._localization && this._friendList && this.var_606 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_477 = new Conversations(new ConversationsDeps(this));
         this.var_205 = new MessengerView(this);
      ...
      {
         var _loc2_:Conversation = this.var_477.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_477.setSelected(_loc2_);
            this.var_205.openMessenger();
            this.var_205.refresh();
         }
      }
      
      public function getActiveConversation() : IConversation
      {
         return !!this.var_477 ? this.var_477.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_477.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_477.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         return this.var_205 && this.var_205.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_205)
         {
            if(this.var_205.isMessengerOpen())
            {
               this.var_205.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_826,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1274,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_477.addMessageAndUpdateView(param1);
         if(!this.var_205.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1344);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1341,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_477.addMessageAndUpdateView(_loc3_);
      }
