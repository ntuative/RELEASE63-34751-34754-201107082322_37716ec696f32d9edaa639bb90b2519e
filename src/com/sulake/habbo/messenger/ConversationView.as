package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1600:int = 10;
      
      private static const const_1096:int = 100;
      
      private static const const_1601:int = 20;
       
      
      private var var_161:HabboMessenger;
      
      private var var_2744:IScrollbarWindow;
      
      private var var_1979:IContainerButtonWindow;
      
      private var var_62:IItemListWindow;
      
      private var var_565:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_161 = param1;
         this.var_1979 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_62 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2744 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_161.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1096 + const_1601)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      public function afterResize() : void
      {
         ...
         var _loc1_:Boolean = this.method_6();
         if(_loc1_)
         {
            this.refreshListDims();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_161.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1600;
         param1.invalidate();
      }
      ...
      {
         var _loc1_:Conversation = this.var_161.conversations.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
         if(this.var_565 == null || _loc1_.id != this.var_565.id)
         {
            this.var_565 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_565.followingAllowed)
         {
            this.var_1979.enable();
         }
         else
         {
            this.var_1979.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_62.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_565.messages.length - const_1096);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_565.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_565.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_161.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_953 || param3.type == Message.const_826 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_565.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_161.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_161.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_161.send(new FollowFriendMessageComposer(this.var_565.id));
         this.var_161.send(new EventLogMessageComposer("Navigation","IM","go.im"));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_161.conversations.closeConversation();
         this.var_161.messengerView.refresh();
      }
