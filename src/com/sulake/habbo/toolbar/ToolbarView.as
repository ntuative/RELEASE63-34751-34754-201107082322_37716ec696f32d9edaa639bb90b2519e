package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1440:Point = new Point(3,3);
      
      private static const const_1551:uint = 7433577;
      
      private static const const_1546:uint = 5723213;
      
      private static const const_482:String = "_hover";
      
      private static const const_480:String = "_normal";
      
      private static const const_481:int = 5;
      
      private static const const_1547:int = 600;
      
      private static const const_1545:int = 80;
      
      private static const const_1550:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1552:int = -2;
      
      private static const const_1549:int = 5;
      
      private static const const_1548:int = 10;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1440;
         this._window.addEventListener(WindowEvent.const_553,this.onParentResized);
         ...
         {
            this.setIconHoverState(_loc11_,const_480);
         }
         ...
         this.var_223 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_223);
         var _loc14_:ITextWindow = this.var_223.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_223.x = _loc13_.width - this.var_223.width - const_481;
         this.var_223.y = const_481;
         this.var_2633 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1547;
         if(!param1 && _loc2_ == this.var_1553)
         {
            return;
         }
         this.var_1553 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1550) : int(const_1545);
         var _loc4_:int = !!_loc2_ ? int(const_1552) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1549 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1548;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_223 != null && this.var_2633)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_786:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_916:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_482);
               this.setIconBgHoverState(_loc3_,const_482);
               break;
            case WindowMouseEvent.const_25:
               this.setIconHoverState(_loc4_,const_480);
               this.setIconBgHoverState(_loc3_,const_480);
         }
      }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_482 ? this.var_1554 : this.var_1555;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_482)
         {
            param1.color = const_1551;
         }
         else
         {
            param1.color = const_1546;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1553 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1553 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         if(this.var_1555)
         {
            this.var_1555.dispose();
         }
         this.var_1555 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1554)
         {
            this.var_1554.dispose();
         }
         this.var_1554 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1034.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_481;
            _loc2_.y = const_481;
