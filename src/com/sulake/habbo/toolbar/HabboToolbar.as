package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1596:String = "purse";
      
      private static const const_1597:String = "extra_tools";
      ...
      private var var_1293:PurseExtension;
      
      private var var_1570:ClubDiscountPromoExtension;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_12:IHabboInventory;
      
      private var var_679:ExtensionView;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_679 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_679)
            {
               this.var_1293 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               ...
               {
                  this.var_1570 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_679.attachExtension(const_1596,this.var_1293.window,ExtensionFixedSlotsEnum.const_1839);
               this.var_679.attachExtension(const_1597,this.var_678.window,ExtensionFixedSlotsEnum.const_1768);
            }
         }
         if(this._view == null)
         {
