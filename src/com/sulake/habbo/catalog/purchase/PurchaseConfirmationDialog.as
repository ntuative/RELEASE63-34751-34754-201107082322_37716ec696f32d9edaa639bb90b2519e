package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2368:int = 10;
      ...
      private const const_2103:uint = 4.293848814E9;
      
      private const const_2104:uint = 4.294967295E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1355 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            _loc6_.addEventListener(WindowEvent.const_112,this.onNameInputChange);
            _loc6_.addEventListener(WindowMouseEvent.const_44,this.onNameInputMouseDown);
            _loc6_.addEventListener(WindowKeyboardEvent.const_334,this.onNameInputKeyUp);
         }
         ...
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_363,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_592,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_2041 = _loc1_.stuffTypes;
            this.var_880 = _loc1_.boxTypes;
            this.var_879 = _loc1_.ribbonTypes;
            this.var_1354 = this.var_2041[0];
            this.var_407 = this.var_880[0];
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_407 < 0)
         {
            this.var_407 = this.var_880.length - 1;
         }
         if(this.var_407 > this.var_880.length - 1)
         {
            this.var_407 = 0;
         }
         var _loc1_:int = this.var_880[this.var_407] * 1000 + this.var_879[this.var_406];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1354,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1632 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_2041)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc3_,ProductTypeEnum.const_77);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1354);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_880[this.var_407]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_879[this.var_406]);
         this._catalog.purchaseProductAsGift(this.var_1634,this.var_1355,this.var_1633,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1634,this.var_1355,this.var_1633);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         for each(_loc5_ in this.var_251)
         {
            ...
            if(_loc4_.length >= this.const_2368)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2867 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_408 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_408 + 1);
               break;
      ...
      {
         if(this.var_293 == null || !this.var_293.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_293.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_408) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_293 == null)
         {
            this.var_293 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_881 == null)
         {
            this.var_881 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_293 == null || this.var_881 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_293.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_881.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_293.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_408) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_408);
         }
         this.var_408 = param1;
         if(this.var_408 < 0)
         {
            this.var_408 = _loc2_.numListItems - 1;
         }
         if(this.var_408 >= _loc2_.numListItems)
         {
            this.var_408 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_408) as IWindowContainer;
      ...
      {
         return param1 % 2 == 0 ? uint(this.const_2103) : uint(this.const_2104);
      }
      ...
      {
         this.var_1354 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1354;
               }
            }
            _loc4_++;
         }
