package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_697:uint = 1;
      ...
      private var var_1216:IRoomSession;
      ...
      private var var_1009:IAvatarRenderManager;
      ...
      private var var_217:CatalogViewer;
      
      private var var_244:ICatalogNavigator;
      ...
      private var var_216:ChargeConfirmationDialog;
      ...
      private var var_2434:Boolean = true;
      
      private var var_2432:Boolean = true;
      
      private var var_1829:Boolean = false;
      
      private var var_2435:GiftWrappingConfiguration;
      
      private var var_1215:ClubGiftController;
      
      private var var_541:ClubBuyController;
      
      private var var_634:ClubExtendController;
      
      private var var_794:Map;
      
      private var var_1214:Boolean = false;
      
      private var var_793:IPurchasableOffer;
      
      private var var_1496:IDragAndDropDoneReceiver;
      ...
      private var var_633:RoomPreviewer;
      
      private const const_2072:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1009)
         {
            this.var_1009.release(new IIDAvatarRenderManager());
            this.var_1009 = null;
         }
         if(this.var_128)
         {
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_69,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_2011);
               return;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2433 = this.isNewItemsNotificationEnabled();
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1009 = param2 as IAvatarRenderManager;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _loc3_.events.addEventListener(RoomSessionEvent.const_69,this.onRoomSessionEvent);
      ...
      {
         if(this._roomEngine != null && this.var_128 != null && this.var_128.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_633 == null)
            {
               this.var_633 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_867 || !this.var_244 || !this.var_244.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_979 = -1;
            this.var_792 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_244.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_128.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
      ...
      {
         var _loc2_:Array = this.var_794.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_217.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_244 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_217 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_217.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_697) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2072;
         this.hideMainWindow();
         ...
         _loc4_.setParamFlag(WindowParam.const_293,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_69:
               this.var_1829 = param1.session.isPrivateRoom;
               this.var_1216 = param1.session;
               if(this.var_105 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1215 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_634 == null)
         {
            this.var_634 = new ClubExtendController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_217 != null)
         {
            this.var_217.catalogWindowClosed();
         }
         if(this.var_105 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_105.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1495 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_244.buildCatalogIndex(_loc2_);
         if(this.var_792 && this.var_792 != "")
         {
            this.var_244.openPage(this.var_792);
            this.var_792 = "";
            this.var_979 = -1;
         }
         else if(this.var_979 > -1)
         {
            this.var_244.openPageById(this.var_979,this.var_1828);
            this.var_979 = -1;
            this.var_1828 = -1;
            this.var_792 = "";
         }
         else if(this.var_1495 && this.var_2433)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_244.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1766));
         }
         else
         {
            this.var_244.loadFrontPage();
         }
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_217.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_217 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_217.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2434 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1367);
         }
         this.var_2434 = false;
         if(this.var_216 != null && !this.var_216.disposed)
         {
            this.var_216.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_130,this.var_111.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2432 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1306);
         }
         this.var_2432 = false;
         if(this.var_216 != null && !this.var_216.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_328,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_927)
         {
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_328,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_111.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1310 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1215.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2435 = new GiftWrappingConfiguration(param1);
      }
      ...
      {
         if(this.var_634 != null && this.var_128.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_634.onOffer(param1);
         }
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_216 == null || this.var_216.disposed)
         {
            this.var_216 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_216.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_794.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_794.add(_loc2_.productCode,_loc3_.slice());
            this.var_217.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1216 || !this.var_1216.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_203);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_218);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1214 && param1.type == RoomEngineObjectEvent.const_161)
         {
            this.resetPlacedOfferData(true);
            if(this.var_793 == null || this.var_793.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_793.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_64 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_793);
            _loc5_ = this.var_1496;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_325,0.5);
            }
         }
      }
            ...
            if(this.var_64.roomCategory == this._roomEngine.activeRoomCategory && this.var_64.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_324:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_218);
                  ...
                  case FurniCategory.const_373:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_203);
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_697);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_633 != null)
         {
            this.var_633.updatePreviewRoomView();
         }
      }
   }
}
