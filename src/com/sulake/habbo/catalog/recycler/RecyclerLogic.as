package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_701 != const_1120;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2064 != RecyclerStatusMessageEvent.const_1345;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_701 == const_487;
      }
      ...
      {
         this.var_701 = const_1119;
         this.var_139 = new Array(const_224);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_2064)
         {
            ...
            case RecyclerStatusMessageEvent.const_1345:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1820:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1263:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1783:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         {
            oldObjectData = this.var_139[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_224)
            {
               oldObjectData = this.var_139[newSlotId];
         ...
         this.var_139[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_139[param1].id))
         {
            return;
         }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_139.length < const_224)
         {
            return false;
         }
         var _loc1_:int = 0;
