package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2077:int = 2;
      
      private const const_2353:int = 40;
      
      private const const_2354:int = 10;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_552)
         {
            this.var_552.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_552 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_824 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_824 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_824));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_652)
         {
            ...
            this.var_652 = _loc5_.buildFromXML(_loc4_) as IWindowContainer;
         }
         if(!this.var_652)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_2077,_loc3_.length,_loc2_);
         if(!this.var_552)
         {
            this.var_552 = new Timer(25);
            this.var_552.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1248 = 0;
         this.populateList();
         this.var_552.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1248 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1248));
            ++this.var_1248;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_652 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_652.clone() as IWindowContainer;
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_824.length)
         {
            _loc4_ = this.var_824[_loc6_.selection];
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_112)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2354;
                  break;
               case "search_input":
                  _loc8_ = this.const_2353;
                  break;
               default:
                  return;
            }
