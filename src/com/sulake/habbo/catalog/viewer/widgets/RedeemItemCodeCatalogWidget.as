package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_992.removeEventListener(WindowKeyboardEvent.const_189,this.windowKeyEventProcessor);
            this.var_992 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_992 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_992 != null)
         {
            this.var_992.addEventListener(WindowKeyboardEvent.const_189,this.windowKeyEventProcessor);
         }
         return true;
      }
