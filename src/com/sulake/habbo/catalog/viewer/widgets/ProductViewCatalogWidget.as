package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_536:IDisplayObjectWrapper;
      
      private var var_1813:Point;
      
      private var var_535:IItemGridWindow;
      
      private var var_1485:IScrollbarWindow;
      
      protected var var_2076:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_973 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1213 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_194 != null)
         {
            ...
            this.var_536 = this.var_194.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_536 != null && _loc3_ != null)
            {
               this.var_194.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_536.width,this.var_536.height);
               if(_loc4_ != null)
               {
                  this.var_536.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1813 = new Point(this.var_98.x,this.var_98.y);
         this.var_535 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1485 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_535 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_2076 = _loc1_.content as XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_535 != null)
         {
            this.var_535.visible = false;
            this.var_535.destroyGridItems();
         }
         ...
         this.var_973.text = _loc4_;
         this.var_1213.text = _loc5_;
         this.var_973.height = this.var_973.textHeight + 5;
         this.var_1213.y = this.var_973.y + this.var_973.height;
         this.var_1213.height = Math.max(130,this.var_1213.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_677:
                  ...
                  if(this.var_535 != null)
                  {
                     this.var_535.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_535,this.var_1485,this.var_2076);
               ...
               case Offer.const_452:
                  ...
                  if(this.var_194 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_77 || _loc9_.productType == ProductTypeEnum.const_64 || _loc9_.productType == ProductTypeEnum.const_193)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_77:
                        if(_loc8_ != null && this.var_536 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_344,AvatarAction.const_659);
                                 _loc18_.appendAction(AvatarAction.const_374,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2406)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_98 != null && true)
         {
            ...
            this.var_98.x = this.var_1813.x;
            this.var_98.y = this.var_1813.y;
            if(param3 != null)
            {
