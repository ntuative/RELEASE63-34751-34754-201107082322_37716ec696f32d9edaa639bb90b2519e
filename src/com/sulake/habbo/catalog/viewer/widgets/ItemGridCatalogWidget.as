package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_230:Boolean = true;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_861,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_313,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_1020,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_302,this.deActivateScrollbar);
         }
         this.var_33 = param2;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_225.stop();
            this.var_225.removeEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_225 = null;
         }
      ...
      override public function init() : Boolean
      {
         ...
         if(this.var_230)
         {
            this.var_225 = new Timer(25);
            this.var_225.addEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_225.start();
         }
         else
         {
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_842 >= 0 && this.var_842 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_842];
                  this.loadGraphics(_loc4_);
                  _loc4_.productContainer.grid = this;
               }
               ++this.var_842;
               if(this.var_842 >= _loc2_)
               {
                  this.resetTimer();
                  break;
               }
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2076) as IWindowContainer;
         ...
         if(param1.pricingModel == Offer.const_677)
         {
            ++this.var_1942;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1942);
         }
      }
