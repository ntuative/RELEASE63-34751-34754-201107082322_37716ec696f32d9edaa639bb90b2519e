package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_476:IButtonWindow;
      ...
      {
         super(param1);
         this.var_476 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1240 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_476 != null)
         {
            this.var_476.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_476.disable();
         }
         this.var_1241 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
         if(this.var_1241 != null)
         {
            this.var_1241.visible = false;
         }
      ...
      override public function dispose() : void
      {
         if(this.var_476 != null)
         {
            this.var_476.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_206);
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_206);
            this._soundManager.musicController.playSong(this.var_996,HabboMusicPrioritiesEnum.const_206,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_996 = parseInt(_loc2_.extraParam);
            if(this.var_1241 != null)
            {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1240.text = _loc8_;
            }
         }
         else if(this.var_1240 != null)
         {
            this.var_1240.text = "";
         }
         if(this.var_476 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_996);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_996);
         }
         return -1;
      }
