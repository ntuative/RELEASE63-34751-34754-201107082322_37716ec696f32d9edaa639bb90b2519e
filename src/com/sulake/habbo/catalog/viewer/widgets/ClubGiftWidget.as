package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc6_)
         {
            _loc2_ = this.var_26.purse.pastVipDays >= this.const_237 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this.var_26.purse.pastVipDays % this.const_237;
            _loc4_ = this.var_26.purse.pastVipDays / this.const_237;
            this.var_26.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_26.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_252)
         {
            this.var_252 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_252)
         {
            return;
         }
         var _loc4_:IBitmapWrapperWindow = this.var_252.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc4_)
         {
            return;
         }
         ...
         this.var_252.setGlobalPosition(_loc6_.subtract(new Point(this.var_252.width / 2,this.var_252.height / 2)));
         this.var_252.visible = true;
         this.var_252.activate();
      }
