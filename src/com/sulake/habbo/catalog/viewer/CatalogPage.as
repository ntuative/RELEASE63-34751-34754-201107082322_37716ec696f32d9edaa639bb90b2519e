package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2057:String = "ctlg_";
       
      
      protected var var_2259:XML;
      ...
      private var var_575:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_575 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1347);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1347);
      }
      ...
      {
         var _loc2_:String = const_2057 + param1;
         ...
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2259) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            ...
            case CatalogWidgetEnum.const_1753:
               ...
               break;
            case CatalogWidgetEnum.const_1874:
            ...
            case CatalogWidgetEnum.const_1796:
               ...
               break;
            case CatalogWidgetEnum.const_2037:
            ...
            case CatalogWidgetEnum.const_1846:
               ...
               break;
            case CatalogWidgetEnum.const_1990:
               this.var_38.push(new SpecialInfoWidget(param1));
               break;
            case CatalogWidgetEnum.const_2025:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_575.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_575 != null)
         {
            return this.var_575.dispatchEvent(param1);
         }
         return false;
      }
