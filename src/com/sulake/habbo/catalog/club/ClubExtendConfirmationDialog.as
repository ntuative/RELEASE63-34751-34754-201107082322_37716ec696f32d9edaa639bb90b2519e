package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_1527:String = "your_price_icon";
      
      private static const const_1528:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1530:String = "image/png";
      
      private static const const_1529:int = 2000;
      
      private static const const_1526:int = 75;
      
      protected static const const_2040:uint = 0;
      ...
      private var var_663:Vector.<BitmapData>;
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_26 = param1;
         this.var_104 = param2;
         this.var_663 = new Vector.<BitmapData>(const_388);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_663)
         {
            ...
            {
               this.var_663[_loc1_].dispose();
               this.var_663[_loc1_] = null;
               _loc1_++;
            }
            this.var_663 = null;
         }
      ...
      public function showConfirmation() : void
      {
         ...
         this.var_665 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1528,const_1530,this.onTeaserLoaded);
         ...
         this.var_391 = this._view.findChildByName(const_1527) as IBitmapWrapperWindow;
         ...
         while(_loc8_ < const_388)
         {
            ...
            this.var_663[_loc8_] = _loc10_.clone();
            _loc8_++;
         }
         this.startAnimation();
      }
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_665)
         {
            this.var_665.textColor = const_2040;
         }
      }
      ...
      private function onMouseOverLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_665)
         {
            this.var_665.textColor = LINK_COLOR_HOVER;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_830 = new Timer(const_1529);
         this.var_830.addEventListener(TimerEvent.TIMER,this.onAnimationTrigger);
         this.var_830.start();
      }
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_391.bitmap)
         {
            this.var_391.bitmap.dispose();
         }
         if(this.var_662 < const_388)
         {
            this.var_391.bitmap = new BitmapData(this.var_391.width,this.var_391.height,true,0);
            this.var_391.bitmap.copyPixels(this.var_663[this.var_662],this.var_663[this.var_662].rect,new Point(0,0));
         }
         else
         {
            Logger.log("Animation frame " + this.var_662);
         }
      }
      
      private function startAnimationFrame() : void
      {
         this.var_454 = new Timer(const_1526,const_388 - 1);
         this.var_454.addEventListener(TimerEvent.TIMER,this.onAnimationFrame);
         this.var_454.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationFrameComplete);
         this.var_454.start();
      }
