package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private var var_1919:Dictionary;
      ...
      {
         this.var_1919 = new Dictionary();
         this.var_2612 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1920 = (param2 & 0) > 0;
         if(!this.var_1920)
         {
            lock();
         }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1920)
            {
               if("false" == this.var_128.getKey("use.default.localizations","false"))
               {
      ...
      {
         this.var_1919[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1919[param1];
      }
      ...
      {
         return this.var_2612[Math.max(0,param1 - 1)];
      }
