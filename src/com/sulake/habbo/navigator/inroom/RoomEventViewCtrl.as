package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2055:IWindowContainer;
      ...
      private var var_1624:IButtonWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_2055.visible = true;
         this.var_2843.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_871.setText(param1.eventDescription);
         this.var_964.setText(this.getTagFromEvent(param1,1));
         this.var_967.setText(this.getTagFromEvent(param1,2));
         this.var_1622.visible = false;
         this.var_1624.visible = true;
         this.var_1623.visible = true;
         this.var_2056.visible = false;
         this.var_2057.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_1082.visible = true;
         this.var_2055.visible = false;
         this.var_1622.visible = true;
         this.var_1624.visible = false;
         this.var_1623.visible = false;
         this.var_871.goBackToInitialState();
         this._eventNameInput.goBackToInitialState();
         this.var_964.goBackToInitialState();
         this.var_967.goBackToInitialState();
         this.var_1082.selection = 0;
         this.var_2056.visible = true;
         this.var_2057.visible = false;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_871.getText();
         var _loc5_:Array = new Array();
         this.addTag(_loc5_,this.var_964.getText());
         this.addTag(_loc5_,this.var_967.getText());
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_871.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_2055 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2843 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_2056 = ITextWindow(this.find("create_caption"));
            this.var_2057 = ITextWindow(this.find("edit_caption"));
            this.var_1622 = IButtonWindow(this.find("create_button"));
            this.var_1624 = IButtonWindow(this.find("edit_button"));
            this.var_2842 = IButtonWindow(this.find("cancel_button"));
            this.var_1623 = IButtonWindow(this.find("end_button"));
            this.var_1082 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            this.addMouseClickListener(this.var_1622,this.onCreateButtonClick);
            this.addMouseClickListener(this.var_1624,this.onEditButtonClick);
            this.addMouseClickListener(this.var_1623,this.onEndButtonClick);
            ...
            this.var_871 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
            this.var_964 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_967 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
