package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_330:MainViewCtrl;
      
      private var var_651:RoomInfoViewCtrl;
      
      private var var_1245:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_468:Tabs;
      ...
      private var var_2534:Array;
      
      private var var_2535:RoomThumbnailRenderer;
      
      private var var_963:GuestRoomPasswordInput;
      
      private var var_337:GuestRoomDoorbell;
      
      private var var_1246:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2534 = new Array();
         ...
         this.var_330 = new MainViewCtrl(this);
         this.var_651 = new RoomInfoViewCtrl(this);
         this.var_1245 = new RoomCreateViewCtrl(this);
         this.var_2535 = new RoomThumbnailRenderer(this);
         this.var_963 = new GuestRoomPasswordInput(this);
         this.var_337 = new GuestRoomDoorbell(this);
         this.var_468 = new Tabs(this);
         this.var_1246 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_342,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_330.onNavigatorToolBarIconClick();
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_330.startSearch(Tabs.const_276,Tabs.const_581,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_330.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_330.startSearch(Tabs.const_299,Tabs.const_244);
         this.var_468.getTab(Tabs.const_299).tabPageDecorator.tabSelected();
      }
