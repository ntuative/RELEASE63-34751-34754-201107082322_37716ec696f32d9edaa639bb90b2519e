package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_741:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:AlertView = var_741[this.var_1154] as AlertView;
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
