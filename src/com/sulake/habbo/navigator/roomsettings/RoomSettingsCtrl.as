package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_965:IDropMenuWindow;
      
      private var var_966:IDropMenuWindow;
      ...
      {
         if(param1 != this.var_373 || this.var_1199 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1199 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_2004)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1811)
         {
         ...
         {
            this.setTagError(this.var_964,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_967,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1936)
         {
            this.setTagError(this.var_964,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_967,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1736)
         {
            this.var_963.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_363,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_495,this.onDoorModePasswordUnselect);
         ...
         this.var_1200 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_964 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_967 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_963 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1197 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1196 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1204 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1198 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_784 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1791 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_965 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_966 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2368 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1203 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1201 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1790 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         ...
         this.var_1202 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1469 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1469.mouseThreshold = 0;
         this.var_1469.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1202.visible = false;
         if(!this.var_1468)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1790.visible = this.var_1468;
         this.populateForm();
         if(this.var_782)
         {
            this.var_1201.visible = true;
            this.var_1470.visible = true;
            this.refreshFlatControllers();
            this.var_1201.height = Util.getLowestPoint(this.var_1201) + 4;
         }
         else
         {
            this.var_1203.visible = true;
            this.var_1470.visible = true;
            this.var_2368.visible = this.var_1468;
            this.var_1203.height = Util.getLowestPoint(this.var_1203) + 4;
         }
         this.var_1469.text = !!this.var_782 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1203.name,this.var_1201.name,this.var_1470.name,this.var_1790.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1200.setText(_loc1_.description);
         this.var_963.setText("");
         ...
         this.setTag(this.var_964,_loc1_.tags[0]);
         this.setTag(this.var_967,_loc1_.tags[1]);
         if(this.var_1196)
         {
            if(_loc1_.allowPets)
            {
               this.var_1196.select();
            }
            else
            {
               this.var_1196.unselect();
            }
         }
         if(this.var_1204)
         {
         ...
         {
            this.disableWindow(this.var_784);
            this.disableWindow(this.var_965);
            this.disableWindow(this.var_966);
            this.disableWindow(this.var_1791);
         }
         else
         {
            this.enableWindow(this.var_784);
            this.enableWindow(this.var_965);
            this.enableWindow(this.var_966);
            this.enableWindow(this.var_1791);
         }
         if(this.var_784)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_784.unselect();
            }
         }
         if(this.var_965)
         {
            this.var_965.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_966)
         {
            this.var_966.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = this.var_1200.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_516;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_134)
         {
            _loc8_ = this.var_963.getText();
         ...
         _loc2_.allowPets = this.var_1196.isSelected;
         _loc2_.allowFoodConsume = this.var_1204.isSelected;
         _loc2_.allowWalkThrough = this.var_1198.isSelected;
         _loc2_.hideWalls = this.var_784.isSelected;
         _loc2_.wallThickness = this.var_965.selection - 2;
         _loc2_.floorThickness = this.var_966.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_964,_loc2_.tags);
         this.addTag(this.var_967,_loc2_.tags);
         this.clearErrors();
