package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1313:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_684 = new Timer(100);
         this.var_684.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_46 = new Array();
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_51,104,"a"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_51,94,"b"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_51,36,"c"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_51,84,"d"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_51,80,"e"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_51,80,"f"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_51,416,"i"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_51,320,"j"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_51,448,"k"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_51,352,"l"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_51,384,"m"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_51,372,"n"));
      ...
      public function dispose() : void
      {
         if(this.var_684)
         {
            this.var_684.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_684.reset();
            this.var_684 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1313.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_2002 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2002 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_62 = IItemListWindow(this.var_201.findChildByName("item_list"));
         ...
         this.var_1312 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_201.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1312.goBackToInitialState();
         this.var_1312.input.textBackgroundColor = 4294967295;
         this.var_1313 = this.var_46[0];
         this.refreshRoomThumbnails();
      ...
      {
         return Boolean(this.var_1312.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1312.getText();
         var _loc3_:String = "model_" + this.var_1313.name;
