package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2535 = new RoomThumbnailRenderer(param1);
         this.var_983 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_208,this.var_142);
         if(this.var_142.ownerName != "" && this.var_142.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_208,!!this.var_142.event ? this.getEventCtg(this.var_142.categoryId) : this.getRoomCtg(this.var_142.categoryId));
         this.refreshRoomDesc(this.var_208,this.var_142);
         this.refreshExtraCont();
         this.refreshInfo(this.var_208,"trading_allowed",this.var_142.allowTrading);
         this.refreshInfo(this.var_208,"doormode_doorbell",this.var_142.doorMode == 1);
         this.refreshInfo(this.var_208,"doormode_password",this.var_142.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_208,this.var_142.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_983.refreshTags(_loc1_,this.var_142.tags);
         ...
         this.var_2535.refreshThumbnail(_loc1_,this.var_142.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_276,Tabs.const_410,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
