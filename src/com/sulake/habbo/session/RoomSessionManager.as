package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_2053)
         {
            this.gotoRoom(this.var_2835,this.var_2837,this.var_2054);
            this.var_2053 = false;
            this.var_2054 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_285,_loc7_));
         return true;
      }
      
      public function startSession(param1:IRoomSession) : Boolean
      {
         if(param1.state == RoomSessionEvent.const_69)
         {
            return false;
         }
         if(param1.start())
         {
            this.var_1621 = false;
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_69,param1));
