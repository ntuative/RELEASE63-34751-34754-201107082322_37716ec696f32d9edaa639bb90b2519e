package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1070:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1492:String = "sendAccessTokenToServer";
      
      private static const const_1491:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1492,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1491,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1070);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1070);
         }
      }
