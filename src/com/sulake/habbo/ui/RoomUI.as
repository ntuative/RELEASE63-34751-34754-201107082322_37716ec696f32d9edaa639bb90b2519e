package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1228:IRoomWidgetFactory;
      ...
      private var var_1230:IHabboHelp;
      ...
      {
         this.var_1506 = RoomDesktop.const_651;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1230.release(new IIDHabboHelp());
            this.var_1230 = null;
         }
         ...
         {
            this.var_988.release(new IIDHabboModeration());
            this.var_988 = null;
         }
         ...
         if(this.var_1229)
         {
            this.var_1229.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1229 = null;
         }
         this.var_1454 = null;
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1454 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_325.events.addEventListener(InterstitialEvent.const_635,this.interstitialCompleteEventHandler);
            this.var_325.events.addEventListener(InterstitialEvent.const_543,this.adEventHandler);
            this.var_325.events.addEventListener(AdEvent.const_655,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1230 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_988 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_988);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_285,this.roomSessionStateEventHandler);
            this.var_15.events.addEventListener(RoomSessionEvent.const_69,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_498,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserBadgesEvent.const_157,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_663,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_775,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1316,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1358,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1025,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_843,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_627,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_170,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPollEvent.const_177,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_629,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionFriendRequestEvent.const_168,this.roomSessionEventHandler);
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_69:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_916);
               break;
            case RoomSessionEvent.const_86:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_786);
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_248:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_775:
            ...
            case RoomSessionErrorMessageEvent.const_734:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_1025:
               errorMessage = "${room.error.pets.forbidden_in_flat}";
               break;
            case RoomSessionErrorMessageEvent.const_973:
               errorMessage = "${room.error.pets.no_free_tiles}";
               break;
            case RoomSessionErrorMessageEvent.const_843:
      ...
      private function interstitialCompleteEventHandler(param1:InterstitialEvent) : void
      {
         ...
         var _loc2_:String = this.getRoomIdentifier(this._interstitialRoomId,this.var_2444);
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1229 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_847,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_188,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_611,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_67,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_919,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_780,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_400,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_272,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_847)
         {
            if(this.var_15 != null)
            {
               this.var_15.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_611 || param1.type == RoomEngineEvent.const_512)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_188:
               _loc5_ = false;
               ...
               _loc3_.disposeWidget(RoomWidgetEnum.const_676);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_998);
               ...
               if(this.var_1506 != RoomDesktop.const_651)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_357,this.var_1506);
               }
               if(this.var_325 != null)
               {
                  this.var_325.showRoomAd(param1.roomId,param1.roomCategory);
               }
            ...
            case RoomEngineEvent.const_339:
               ...
               break;
            case RoomEngineRoomColorEvent.const_919:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         if(_loc3_.showInterstitial())
         {
            ...
            this.var_2444 = param1.roomCategory;
         }
         else
         {
            this.var_1507 = false;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_651)
            {
