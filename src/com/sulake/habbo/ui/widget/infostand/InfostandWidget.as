package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_2093:String = "infostand_user_view";
      
      private const const_2094:String = "infostand_furni_view";
      
      private const const_2090:String = "infostand_pet_view";
      
      private const const_2092:String = "infostand_bot_view";
      
      private const const_2091:String = "infostand_jukebox_view";
      
      private const const_2095:String = "infostand_songdisk_view";
      
      private var var_1357:InfoStandFurniView;
      ...
      private var var_1088:InfoStandJukeboxView;
      
      private var var_1089:InfoStandSongDiskView;
      
      private var var_2873:Array;
      
      private var var_1635:InfostandUserData;
      
      private var var_694:InfostandFurniData;
      ...
      public function InfostandWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboCatalog)
      {
         ...
         this.var_1357 = new InfoStandFurniView(this,this.const_2094,this._catalog);
         this.var_203 = new InfoStandUserView(this,this.const_2093);
         this.var_409 = new InfoStandPetView(this,this.const_2090,this._catalog);
         this.var_470 = new InfoStandBotView(this,this.const_2092);
         this.var_1088 = new InfoStandJukeboxView(this,this.const_2091,this._catalog);
         this.var_1089 = new InfoStandSongDiskView(this,this.const_2095,this._catalog);
         this.var_1635 = new InfostandUserData();
         this.var_694 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_181 = new Timer(this.const_2369);
         this.var_181.addEventListener(TimerEvent.TIMER,this.onUpdateTimer);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_378,this.onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_157,this.onUserBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_830,this.onBadgeImage);
         ...
         param1.addEventListener(RoomWidgetSongUpdateEvent.const_421,this.onSongUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_378,this.onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_157,this.onUserBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_830,this.onBadgeImage);
         ...
         param1.removeEventListener(RoomWidgetSongUpdateEvent.const_421,this.onSongUpdate);
      }
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_252,this.var_409.getCurrentPetId()));
      }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_571)
         {
            this.var_1088.update(param1);
            this.selectView(this.const_2091);
         }
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_433) != -1)
         {
            this.var_1089.update(param1);
            this.selectView(this.const_2095);
         }
         else
         {
            this.var_1357.update(param1);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_203.setTags(param1.tags,this.var_2873);
         }
      }
      ...
      {
         var _loc2_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_544,param1.id,param1.category);
      ...
      {
         this.var_1088.updateSongInfo(param1);
         this.var_1089.updateSongInfo(param1);
      }
