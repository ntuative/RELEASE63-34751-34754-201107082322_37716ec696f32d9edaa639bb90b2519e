package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1472:int = 16;
      
      private static const const_695:int = 4;
      
      private static const const_1476:uint = 14342874;
      
      private static const const_1483:uint = 3815994;
      
      private static const const_1482:uint = 2085362;
      
      private static const const_1477:uint = 39616;
      
      private static const const_1478:uint = 10513106;
      
      private static const const_1481:uint = 8734654;
      
      private static const const_1474:uint = 9094430;
      
      private static const const_1470:uint = 6200576;
      
      private static const const_1473:String = "happiness";
      
      private static const const_1475:String = "experience";
      
      private static const const_1479:String = "energy";
      
      private static const const_1480:int = 250;
      
      private static const const_1062:int = 25;
      
      private static const const_1063:int = 5;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1473,param1.nutrition,param1.nutritionMax,const_1477,const_1482);
         this.updateStateElement(const_1475,param1.experience,param1.experienceMax,const_1481,const_1478);
         this.updateStateElement(const_1479,param1.energy,param1.energyMax,const_1470,const_1474);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1471,const_1472,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1476);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1483);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_695,_loc7_.width - 2,_loc7_.height - 2 - const_695);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_695);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_534) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_214 && this.var_214.getPetId() == this.var_534)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1922,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_395,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1062 + const_1063;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1063;
            }
         }
         this.var_108.height = _loc4_ + const_1062;
         this.updateWindow();
      }
   }
}
