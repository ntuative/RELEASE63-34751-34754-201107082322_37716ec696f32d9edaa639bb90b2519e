package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_1179:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1178 = 0;
         this.var_1179 = param2.rectangle.clone();
         this.var_1179.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1179.width)
         {
            return false;
         }
         if(this.var_1178 + param1.height > this.var_1179.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1179.width)
         {
            this._offsetX = 0;
            this.var_1178 += param1.height + this.const_2342;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1178);
      ...
      {
         var _loc2_:* = null;
         if(this.var_1460 != null && this.var_1460.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_180);
