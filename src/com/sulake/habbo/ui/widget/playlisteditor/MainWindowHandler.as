package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MainWindowHandler
   {
      ...
      private static const const_1593:int = 6;
      
      private static const const_1595:int = 9;
      
      private static const const_1594:int = 5;
      ...
      private var var_1062:IBorderWindow;
      
      private var var_1063:IBorderWindow;
      
      private var var_564:MusicInventoryGridView;
      
      private var var_850:PlayListEditorItemListView;
      
      private var var_255:MusicInventoryStatusView;
      
      private var var_335:PlayListStatusView;
      
      private var var_1969:IScrollbarWindow;
      
      private var var_1970:IScrollbarWindow;
      ...
      public function MainWindowHandler(param1:PlayListEditorWidget, param2:IHabboMusicController)
      {
         ...
         this._widget = param1;
         this.var_254 = param2;
         var _loc3_:Array = [PlayListEditorWidgetAssetsEnum.const_743,PlayListEditorWidgetAssetsEnum.const_796,PlayListEditorWidgetAssetsEnum.const_550,PlayListEditorWidgetAssetsEnum.const_613,PlayListEditorWidgetAssetsEnum.const_900];
         ...
         this.createWindow();
         this.var_564 = new MusicInventoryGridView(param1,this.getMusicInventoryGrid(),param2);
         ...
         this.var_335 = new PlayListStatusView(param1,this.getPlayListStatusContainer());
      ...
      public function destroy() : void
      {
         if(this.var_254)
         {
            this.var_254.stop(HabboMusicPrioritiesEnum.const_450);
            this.var_254 = null;
         }
         if(this.var_564)
         {
            this.var_564.destroy();
            this.var_564 = null;
         }
         if(this.var_850)
         {
      ...
      public function refreshLoadableAsset(param1:String = "") : void
      {
         ...
         {
            this.assignWindowBitmapByAsset(this.var_1062,"music_inventory_splash_image",PlayListEditorWidgetAssetsEnum.const_743);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_796)
         {
            this.assignWindowBitmapByAsset(this.var_1063,"playlist_editor_splash_image",PlayListEditorWidgetAssetsEnum.const_796);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_550)
         {
            this.var_255.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_550));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_613)
         {
            this.var_255.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_613));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_900)
         {
            this.var_335.addSongsBackgroundImage = this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_900);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1062 = _loc2_.getChildByName("my_music_border") as IBorderWindow;
         this.var_1063 = _loc2_.getChildByName("playlist_border") as IBorderWindow;
         ...
         this.var_1969 = this.var_1062.getChildByName("music_inventory_scrollbar") as IScrollbarWindow;
         this.var_1970 = this.var_1063.getChildByName("playlist_scrollbar") as IScrollbarWindow;
      ...
      {
         return this.var_1062.getChildByName("music_inventory_itemgrid") as IItemGridWindow;
      }
      
      private function getPlayListEditorItemList() : IItemListWindow
      {
         return this.var_1063.getChildByName("playlist_editor_itemlist") as IItemListWindow;
      }
      
      private function getMusicInventoryStatusContainer() : IWindowContainer
      {
         return this.var_1062.getChildByName("preview_play_container") as IWindowContainer;
      }
      
      private function getPlayListStatusContainer() : IWindowContainer
      {
         return this.var_1063.getChildByName("now_playing_container") as IWindowContainer;
      }
      ...
      private function selectPlayListStatusViewByFurniPlayListState() : void
      {
         ...
         if(_loc1_.isPlaying)
         {
            this.var_335.selectView(PlayListStatusView.const_594);
         }
         else if(_loc1_.length > 0)
         {
            this.var_335.selectView(PlayListStatusView.const_1387);
         }
         else
         {
            this.var_335.selectView(PlayListStatusView.const_963);
         }
      }
      ...
      private function selectMusicStatusViewByMusicState() : void
      {
         ...
         {
            this.var_255.show();
            this.var_255.selectView(MusicInventoryStatusView.const_865);
         }
         else if(this.var_254.getSongDiskInventorySize() <= const_1593)
         {
            this.var_255.show();
            this.var_255.selectView(MusicInventoryStatusView.const_839);
         }
         else
         {
            this.var_255.hide();
      ...
      public function onPlayListUpdated() : void
      {
         ...
         if(_loc2_ != -1)
         {
            ...
            this.var_335.nowPlayingTrackName = _loc3_.name;
            this.var_335.nowPlayingAuthorName = _loc3_.creator;
         }
         this.var_1970.visible = _loc1_.length > const_1594;
      }
      
      public function onSongDiskInventoryReceived() : void
      {
         this.var_564.refresh();
         this.selectMusicStatusViewByMusicState();
         this.var_1969.visible = this.var_564.itemCount > const_1595;
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetPlayListEditorNowPlayingEvent.const_102:
               ...
               if(param1.id != -1)
               {
                  ...
                  this.var_335.nowPlayingTrackName = _loc3_ != null ? _loc3_.name : "";
                  this.var_335.nowPlayingAuthorName = _loc3_ != null ? _loc3_.creator : "";
               }
               break;
            case RoomWidgetPlayListEditorNowPlayingEvent.const_136:
               this.var_564.method_13();
            ...
            case RoomWidgetPlayListEditorNowPlayingEvent.const_135:
               this.var_564.setPreviewIconToPlay();
               this.selectMusicStatusViewByMusicState();
         }
      }
      ...
      {
         return this.var_254.getSongIdPlayingAtPriority(HabboMusicPrioritiesEnum.const_450) != -1;
      }
   }
}
