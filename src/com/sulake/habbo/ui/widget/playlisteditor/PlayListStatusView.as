package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_963:String = "PLSV_ADD_SONGS";
      
      public static const const_1387:String = "PLSV_START_PLAYBACK";
      
      public static const const_594:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_594)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_439[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_439[const_963];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_439.add(const_594,_loc1_);
