package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2097:int = 0;
      
      private const const_2098:int = 1;
      
      private const const_2100:int = 2;
      
      private const const_2099:int = 3;
      
      private const const_2102:int = 4;
      
      private const const_2374:int = 0;
      
      private const const_2377:int = 1;
      ...
      private const const_2101:String = "dialog_bg";
      
      private const const_2372:String = "%campaign%_dialog_bg.png";
      
      private const const_392:String = "%campaign%_gift_package.png";
      
      private const const_2378:String = "%campaign%_gift_content.png";
      
      private const const_2371:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1638 = this.var_153.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1638 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1641.length)
         {
            _loc2_ = this.var_1641.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_153 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_522,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_962,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_522,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_522:
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_969:
               ...
               this._shareId = null;
               this.var_1640 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_962:
         ...
         if(this._window && (this.var_1639 != _loc2_ || _loc3_ != this.var_204))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_204 = _loc3_;
         this.var_1639 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1639)
            {
               ...
               case this.const_2098:
                  if(this.var_432 == this.const_2374)
                  {
                  ...
                  else if(this.var_432 == this.const_2377)
                  {
                     ...
                     _loc2_ = this.const_2378;
                  }
                  else if(this.var_432 == this.const_2370)
                  {
                  ...
                  else if(this.var_432 == this.const_2376)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_432 == this.const_2375)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_204,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_432 == this.const_2373)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2372.replace("%campaign%",this.var_204);
            this.setDecoImage(_loc5_,this.const_2101);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_12)
         {
            if(this.var_1640 != 0)
            {
               this.var_12.toggleInventoryPage(this.var_1640 == 1 ? "null" : InventoryCategory.const_131);
            }
         }
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1641.push(new ImageDownloader(this,_assets,this.var_204,this.var_1638,param1,param2));
            return;
         }
