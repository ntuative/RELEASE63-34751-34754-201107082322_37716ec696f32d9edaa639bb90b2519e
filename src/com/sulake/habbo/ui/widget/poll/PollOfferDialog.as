package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1738:String = "POLL_OFFER_STATE_OK";
      
      public static const const_899:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_115:String = "POLL_OFFER_STATE_UNKNOWN";
      ...
      {
         if(this._state != const_115)
         {
            return;
         }
         this._state = const_1738;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_750,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_546,this._id));
