package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1905:MeMenuSoundSettingsView;
      ...
      {
         if(param1.type != WindowEvent.const_394)
         {
            return;
         }
         this.var_1905.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_803 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_803.width,this.var_803.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_803,this.var_803.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_802 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_802.width,this.var_802.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_802,this.var_802.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1840 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
