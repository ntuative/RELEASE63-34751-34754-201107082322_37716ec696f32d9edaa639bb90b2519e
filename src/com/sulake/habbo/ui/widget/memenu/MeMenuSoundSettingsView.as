package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1059:MeMenuSoundSettingsSlider;
      
      private var var_1055:BitmapData;
      ...
      {
         this.var_1013 = param1.volume;
         if(this.var_1059 != null)
         {
            this.var_1059.setValue(this.var_1013);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1055 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1056 = (_loc5_.content as BitmapData).clone();
         }
         ...
         this.var_1059 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_825));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_1013 == 0)
         {
            ...
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1055);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1057);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1056);
         }
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               this._widget.changeView(MeMenuWidget.const_744);
               break;
            default:
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_831);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_816);
         }
