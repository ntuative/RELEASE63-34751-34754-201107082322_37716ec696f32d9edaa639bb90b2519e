package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class UserChooserWidget extends ChooserWidgetBase
   {
      ...
      private var var_455:ChooserView;
      ...
      {
         if(this.var_455 != null && this.var_455.isOpen())
         {
            return this.const_2080;
         }
         return this.const_2355;
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_970,this.onUpdateUserChooser);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_970,this.onUpdateUserChooser);
      }
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(this.var_455 == null)
         {
            this.var_455 = new ChooserView(this,"${widget.chooser.user.title}");
         }
         this.var_455.populate(param1.items,false);
      }
