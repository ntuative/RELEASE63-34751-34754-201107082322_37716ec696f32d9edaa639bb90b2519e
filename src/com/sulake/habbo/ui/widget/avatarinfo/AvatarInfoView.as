package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView implements IDisposable
   {
      ...
      protected static const const_1038:uint = 4282950861;
      
      protected static const const_2054:uint = 4288230144;
      
      protected static const const_1415:uint = 16777215;
      
      protected static const const_1416:uint = 9552639;
      
      protected static const const_2053:uint = 16777215;
      
      protected static const const_2055:uint = 5789011;
      
      protected static const const_2056:uint = 13947341;
      
      protected static const const_2052:uint = 5789011;
      
      private static const const_1626:int = 25;
      ...
      protected var var_2371:int;
      
      protected var var_1759:Boolean;
      
      protected var var_2257:FixedSizeStack;
      
      protected var var_2258:int = -1000000;
      ...
      {
         this.var_2257 = new FixedSizeStack(const_1626);
         super();
         this._widget = param1;
         this.var_1146 = true;
         this.var_1709 = false;
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1707 = param5;
         param1.var_2371 = param4;
         ...
         if(param1.var_1146)
         {
            if(!param1.var_509)
            {
               param1.var_509 = new Timer(param1.var_3058,1);
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_602));
      ...
      public function update(param1:Rectangle, param2:Point, param3:uint) : void
      {
         ...
         if(this.var_1710)
         {
            ...
            this._blend = 1 - this.var_1708 / Number(this.var_3059);
         }
         else
         {
            this._blend = 1;
         ...
         if(!this.var_1759 || this.var_2042)
         {
            _loc4_ = -this.var_191.height;
            if(this.var_1707 == RoomObjectTypeEnum.const_127 || this.var_1707 == RoomObjectTypeEnum.const_557)
            {
            ...
            this.var_2257.addValue(_loc5_);
            _loc6_ = this.var_2257.getMax();
            if(_loc6_ < this.var_2258 - const_1115)
            {
               _loc6_ = this.var_2258 - const_1115;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2258 = _loc6_;
