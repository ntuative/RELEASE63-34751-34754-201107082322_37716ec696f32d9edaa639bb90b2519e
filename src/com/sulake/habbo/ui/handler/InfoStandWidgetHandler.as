package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_254.events.addEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
            this.var_254.events.addEventListener(SongInfoReceivedEvent.const_100,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_191,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_233,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_191,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_233,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_675.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_675.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_254 != null)
         {
            this.var_254.events.removeEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
            this.var_254.events.removeEventListener(SongInfoReceivedEvent.const_100,this.onSongInfoReceivedEvent);
            this.var_254 = null;
         }
         this.var_1148 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_544);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_776);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_312);
         _loc1_.push(RoomWidgetFurniActionMessage.const_764);
         _loc1_.push(RoomWidgetFurniActionMessage.const_795);
         _loc1_.push(RoomWidgetFurniActionMessage.const_779);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1198);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_872);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_1013);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_946);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1970);
         _loc1_.push(RoomWidgetPetCommandMessage.const_621);
         _loc1_.push(RoomWidgetPetCommandMessage.const_939);
         _loc1_.push(RoomWidgetUserActionMessage.const_559);
         _loc1_.push(RoomWidgetUserActionMessage.const_252);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_733);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_654)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_252 || param1.type == RoomWidgetUserActionMessage.const_559 || param1.type == RoomWidgetUserActionMessage.const_511)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_544:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_776:
            ...
            case RoomWidgetUserActionMessage.const_523:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1322,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_1198:
               ...
               break;
            case RoomWidgetUserActionMessage.const_252:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_872:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_1013:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_946:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_250);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_378);
               _loc6_.id = param1.id;
               ...
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_805) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1380;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_250);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1386);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1250);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_571)
                  {
                     _loc30_ = this.var_254.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_433) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_433.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_254.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_232)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_557)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_351);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_163)
               {
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_915;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_978;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1999);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_157];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_157:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_675.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_675.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_254 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_254.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_254 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_421,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
